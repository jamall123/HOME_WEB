import{t as m}from"./ProgressController-ksCq6T2Z.js";import{n as s,t as u}from"./ReportGenerator-DGWhhGX1.js";var p=class{constructor(){this.engine=null}async init(t){this.engine=t,this.injectTab()}injectTab(){const t=document.getElementById("inst-tabs");if(!t)return;const e=document.createElement("button");e.className="tab-btn",e.dataset.target="tab-content-analytics",e.innerHTML='<i class="fas fa-chart-pie"></i> مركز الإحصائيات',t.appendChild(e);const r=document.createElement("div");r.id="tab-content-analytics",r.className="tab-content",document.getElementById("instructor-dashboard")?.appendChild(r),e.addEventListener("click",()=>{document.querySelectorAll("#inst-tabs .tab-btn").forEach(a=>a.classList.remove("active")),document.querySelectorAll(".tab-content").forEach(a=>a.classList.remove("active")),e.classList.add("active"),r.classList.add("active"),this.renderDashboard(r)})}async renderDashboard(t){t.innerHTML='<div style="text-align:center; padding: 2rem;"><i class="fas fa-spinner fa-spin fa-2x"></i> جاري جلب الإحصائيات...</div>';try{const e=await m.fetchInstructorDashboardData();t.innerHTML=`
            ...
            `,document.getElementById("btn-download-course-report").addEventListener("click",()=>{u.generateCourseReport([["Course Wide Data",e.healthScore,e.dropOffRate,e.totalWatchTime]])}),setTimeout(()=>{s.renderDoughnutChart("course-completion-chart",[e.averageCompletion,100-e.averageCompletion],["#2ecc71","#e74c3c"])},100),this.renderResourcesChart(t)}catch{t.innerHTML='<div style="color:var(--danger); padding: 1rem;">حدث خطأ أثناء تحميل البيانات</div>'}}async renderResourcesChart(t){const e=t.querySelector("#course-resources-chart");if(e)try{const r=await window.firebase.firestore().collection("courses").doc(this.engine.courseId).collection("resources").get();if(r.empty){e.replaceWith(Object.assign(document.createElement("p"),{style:"color:#888; text-align:center; padding: 2rem 0; margin:0;",textContent:"لا توجد ملفات موارد مرفوعة بعد لهذه الدورة."}));return}const a={};r.docs.forEach(i=>{const{url:d="",name:l=""}=i.data(),n=(d.split("?")[0].split(".").pop()||l.split(".").pop()||"أخرى").toLowerCase();a[n]=(a[n]||0)+1});const o=Object.keys(a),c=Object.values(a);setTimeout(()=>{s.renderBarChart("course-resources-chart",c,o,"#9b59b6")},0)}catch{e.replaceWith(Object.assign(document.createElement("p"),{style:"color:var(--danger); text-align:center; padding: 2rem 0; margin:0;",textContent:"تعذر تحميل بيانات الملفات."}))}}},v=new p;export{v as InstructorAnalyticsUI};
