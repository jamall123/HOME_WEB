const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CommandBus-C_R7KGFc.js","assets/UserRepository-Qg-1MUAM.js","assets/rolldown-runtime-BQ-_32WO.js","assets/CourseRepository-BkU7rJA0.js","assets/EventBus-4Q0tYHVL.js","assets/NotificationManager-DMg0JkUo.js","assets/courseRoom-C3iVTKTu.js","assets/firebase-config-DkUYsNQt.js","assets/ChatRepository-czIRHjD2.js","assets/preload-helper-BATLnrmA.js","assets/CurriculumRepository-BvNRSpvs.js","assets/CurriculumProgress-KEuHJ4WM.js","assets/StudentProgressRepository-kYhNGkTs.js","assets/courseRoom-Dd8DccWn.css","assets/sudanFree-CgE2LGLP.css","assets/MediaEngine-MRBtyyxG.js","assets/MediaRepository-CV7UmlOS.js"])))=>i.map(i=>d[i]);
import{n as b,r as I,t as v}from"./CourseRepository-BkU7rJA0.js";import{i as M,r as C}from"./EventBus-4Q0tYHVL.js";import{t as m}from"./preload-helper-BATLnrmA.js";import{r as k,t as x}from"./courseRoom-C3iVTKTu.js";import{t as S}from"./MediaRepository-CV7UmlOS.js";import"./InstructorAnalyticsUI-Bd4L8cCa.js";var h={get db(){return I.getFirestore()},get storage(){return I.getStorage()},async updateProfile(e,t){if(!e)throw new Error("No UID provided");await this.db.collection(b.COLLECTIONS.USERS).doc(e).set(t,{merge:!0})},async updateCourseProfile(e,t){if(!e)throw new Error("No courseId provided");await this.db.collection(b.COLLECTIONS.COURSES).doc(e).set({instructor:t.name||null,instructorSpecialty:t.specialty||null,instructorBio:t.bio||null,instructorPhoto:t.photo||null},{merge:!0})},uploadMedia(e,t,i=null){return new Promise((s,n)=>{const o=this.storage.ref().child(`${t}/${Date.now()}_${e.name}`).put(e);o.on("state_changed",a=>{i&&i(a.bytesTransferred/a.totalBytes*100)},a=>n(a),async()=>{s(await o.snapshot.ref.getDownloadURL())})})},async updateTeachingMode(e,t){const i={updatedAt:I.getFirestoreFieldValue().serverTimestamp()};for(const[s,n]of Object.entries(t))if(s==="metadata"&&typeof n=="object")for(const[o,a]of Object.entries(n))i[`metadata.${o}`]=a;else i[s]=n;try{await this.db.collection(b.COLLECTIONS.ACTIVE_SESSIONS).doc(e).update(i)}catch{const n={...t,updatedAt:I.getFirestoreFieldValue().serverTimestamp()};await this.db.collection(b.COLLECTIONS.ACTIVE_SESSIONS).doc(e).set(n,{merge:!0})}},async addChannelMessage(e,t){if(!e)throw new Error("No courseId provided");await this.db.collection(b.COLLECTIONS.COURSES).doc(e).collection(b.COLLECTIONS.CHANNEL_MESSAGES).add(t)},async updateClassroomState(e,t){await this.db.collection(b.COLLECTIONS.ACTIVE_SESSIONS).doc(e).set({permissions:t,updatedAt:I.getFirestoreFieldValue().serverTimestamp()},{merge:!0})},async getResources(e){return(await this.db.collection(b.COLLECTIONS.LESSON_RESOURCES).where("courseId","==",e).get()).docs.map(t=>({id:t.id,...t.data()}))},async dispatchCommand(e){const{commandBus:t}=await m(async()=>{const{commandBus:i}=await import("./CommandBus-C_R7KGFc.js");return{commandBus:i}},__vite__mapDeps([0,1,2,3]));return t.dispatch(e)},async postAnnouncement(e,t){await this.db.collection(b.COLLECTIONS.LESSON_ANNOUNCEMENTS).add({courseId:e,...t,timestamp:I.getFirestoreFieldValue().serverTimestamp()})}},_=class{constructor(){}async updateProfile(e,t){await h.updateProfile(e,t)}async updateCourseProfile(e,t){await h.updateCourseProfile(e,t)}uploadMedia(e,t,i=null){return h.uploadMedia(e,t,i)}async updateTeachingMode(e,t){await h.updateTeachingMode(e,t)}async addChannelMessage(e,t,i){t&&(i.lessonId=t),await h.addChannelMessage(e,i)}async updateClassroomState(e,t){await h.updateClassroomState(e,t)}async getResources(e){return await h.getResources(e)}async postAnnouncement(e,t){await h.postAnnouncement(e,t)}},w=new _,g={show({icon:e="📢",title:t="تأكيد",body:i="",okLabel:s="تأكيد",cancelLabel:n="إلغاء",danger:o=!1}={}){return new Promise(a=>{const r=document.getElementById("room-confirm-overlay"),l=document.getElementById("confirm-icon"),u=document.getElementById("confirm-title"),d=document.getElementById("confirm-body"),c=document.getElementById("confirm-ok-btn"),y=document.getElementById("confirm-cancel-btn");if(!r){a(!0);return}l&&(l.textContent=e),u&&(u.textContent=t),d&&(d.textContent=i),c&&(c.textContent=s),y&&(y.textContent=n),c&&(c.className=o?"btn-confirm-ok danger-ok":"btn-confirm-ok");const f=E=>{r.classList.remove("active"),c.onclick=null,y.onclick=null,a(E)};c.onclick=()=>f(!0),y.onclick=()=>f(!1),r.onclick=E=>{E.target===r&&f(!1)},r.classList.add("active")})},alert({icon:e="ℹ️",title:t="تنبيه",body:i="",okLabel:s="حسناً"}={}){return new Promise(n=>{const o=document.getElementById("room-confirm-overlay");if(!o){n();return}document.getElementById("confirm-icon").textContent=e,document.getElementById("confirm-title").textContent=t,document.getElementById("confirm-body").textContent=i,document.getElementById("confirm-ok-btn").textContent=s,document.getElementById("confirm-cancel-btn").style.display="none";const a=document.getElementById("confirm-ok-btn");a.className="btn-confirm-ok";const r=()=>{o.classList.remove("active"),a.onclick=null,document.getElementById("confirm-cancel-btn").style.display="",n()};a.onclick=()=>r(),o.onclick=l=>{l.target===o&&r()},o.classList.add("active")})}},B={show({title:e="بيانات الدرس",body:t="يرجى إدخال عنوان وتفاصيل الدرس الجديد",okLabel:i="حفظ",cancelLabel:s="إلغاء"}={}){return new Promise(n=>{const o=document.getElementById("room-prompt-overlay"),a=document.getElementById("prompt-title"),r=document.getElementById("prompt-body"),l=document.getElementById("prompt-input-title"),u=document.getElementById("prompt-input-desc"),d=document.getElementById("prompt-ok-btn"),c=document.getElementById("prompt-cancel-btn");if(!o){n({title:null,description:null});return}a&&(a.textContent=e),r&&(r.textContent=t),d&&(d.textContent=i),c&&(c.textContent=s),l.value="",u.value="";const y=f=>{o.classList.remove("active"),d.onclick=null,c.onclick=null,n(f?{title:l.value.trim()||null,description:u.value.trim()||""}:{title:null,description:null})};d.onclick=()=>y(!0),c.onclick=()=>y(!1),o.classList.add("active"),l.focus()})}};window.RoomConfirmDialog=g;window.RoomPromptDialog=B;var L=class{init(e){this.controller=e,this.cacheDOM(),this.renderDashboardLayout(),this.attachListeners()}cacheDOM(){this.mountPoint=document.getElementById("instructor-dashboard-mount"),this.tabBtn=document.getElementById("tab-btn-instructor-side")}renderDashboardLayout(){this.mountPoint&&(this.tabBtn&&(this.tabBtn.style.display="flex"),this.mountPoint.innerHTML=`
...
هل أنت جاهز لبدء البث؟`,okLabel:"بدء البث"})&&this.controller.startAgoraLive().catch(async i=>{await g.alert({icon:"❌",title:"خطأ",body:"تعذر بدء البث: "+i.message})})},stopAgoraLiveDedicated:async()=>{await g.show({icon:"⏹",title:"إنهاء البث",body:"هل تريد إنهاء البث الحي الآن؟",okLabel:"إنهاء البث",danger:!0})&&(this.controller.stopAgoraLive(),document.getElementById("btn-start-agora-live").style.display="block",document.getElementById("btn-stop-agora-live").style.display="none",document.getElementById("live-on-badge").style.display="none",document.getElementById("live-ws-status").textContent="البث غير نشط حالياً",document.getElementById("float-btn-mic").style.display="none",document.getElementById("float-btn-cam").style.display="none",document.getElementById("float-btn-stop").style.display="none",this._stopTimer("live-ws-timer"))},toggleAgoraMic:async()=>{const{MediaEngine:i}=await m(async()=>{const{MediaEngine:a}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:a}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16])),s=i.toggleMic(),n=["btn-agora-mic","btn-live-mic"],o=document.getElementById("float-btn-mic");n.forEach(a=>{const r=document.getElementById(a);r&&(r.innerHTML=s?'<i class="fas fa-microphone-slash"></i> مكتوم':'<i class="fas fa-microphone"></i> المايك',s?r.classList.add("btn-danger"):r.classList.remove("btn-danger"))}),o&&(o.innerHTML=s?'<i class="fas fa-microphone-slash"></i><span class="fb-label"> مكتوم</span>':'<i class="fas fa-microphone"></i><span class="fb-label"> المايك</span>',s?o.classList.add("active"):o.classList.remove("active"))},switchAgoraCamera:async()=>{const{MediaEngine:i}=await m(async()=>{const{MediaEngine:s}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:s}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));i.switchCamera()},sendChannelMessage:async()=>{const i=document.getElementById("inst-channel-text"),s=i?i.value.trim():"";if(!s){await g.alert({icon:"✏️",title:"الرسالة فارغة",body:"يرجى كتابة رسالة قبل الإرسال."});return}await g.show({icon:"📢",title:"تأكيد إرسال الرسالة",body:s.length>120?s.slice(0,120)+"...":s,okLabel:"إرسال"})&&this.controller.sendChannelMessage()},sendChannelImage:async i=>{const s=i.target.files[0];s&&(await g.show({icon:"🖼️",title:"إرسال صورة",body:`هل تريد إرسال الصورة "${s.name}" للطلاب؟`,okLabel:"إرسال الصورة"})?this.controller.sendChannelImage(i):i.target.value="")},sendChannelVideo:async i=>{const s=i.target.files[0];s&&(await g.show({icon:"🎬",title:"إرسال فيديو",body:`هل تريد إرسال الفيديو "${s.name}" للطلاب؟`,okLabel:"إرسال الفيديو"})?this.controller.sendChannelVideo(i):i.target.value="")},toggleChannelVoice:()=>this.controller.toggleChannelVoice()},this._wireFloatBar(),this._updateFloatBar("video");const e=this.mountPoint.querySelectorAll(".inst-nav");e.forEach(i=>{i.addEventListener("click",s=>{const n=s.currentTarget.getAttribute("data-view");e.forEach(a=>{a.classList.remove("btn-primary"),a.classList.add("btn-dark")}),s.currentTarget.classList.remove("btn-dark"),s.currentTarget.classList.add("btn-primary"),this.mountPoint.querySelectorAll(".inst-view").forEach(a=>a.style.display="none");const o=this.mountPoint.querySelector(`#inst-view-${n}`);o&&(o.style.display="flex"),n==="dashboard"&&o&&(o.style.flexDirection="column")})});const t=this.mountPoint.querySelector("#inst-profile-form");t&&t.addEventListener("submit",async i=>{i.preventDefault();const s=t.querySelector('button[type="submit"]'),n=s.innerHTML;s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...',s.disabled=!0;const o={name:document.getElementById("inst-prof-name").value.trim(),specialty:document.getElementById("inst-prof-spec").value.trim(),bio:document.getElementById("inst-prof-bio").value.trim()},a=document.getElementById("inst-prof-photo").files[0],r=document.getElementById("inst-prof-cv").files[0];try{const{InstructorService:l}=await m(async()=>{const{InstructorService:u}=await import("./InstructorService-DFH8LYX2.js");return{InstructorService:u}},[]);a&&(s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري رفع الصورة...',o.photo=await l.uploadMedia(a,`profiles/${this.controller.engine.currentUser.uid}`)),r&&(s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري رفع السيرة...',o.cv=await l.uploadMedia(r,`profiles/${this.controller.engine.currentUser.uid}`)),s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...',await this.controller.updateProfile(o),s.innerHTML='<i class="fas fa-check"></i> تم الحفظ بنجاح',setTimeout(()=>{s.innerHTML=n,s.disabled=!1},3e3)}catch(l){await g.alert({icon:"❌",title:"خطأ",body:"حدث خطأ: "+(l.message||"")}),s.innerHTML=n,s.disabled=!1}})}_startTimer(e){this._stopTimer(e);const t=document.getElementById(e);if(!t)return;t.style.display="block";let i=0;this._timers=this._timers||{},this._timers[e]=setInterval(()=>{i++;const s=String(Math.floor(i/60)).padStart(2,"0"),n=String(i%60).padStart(2,"0");t.textContent=`${s}:${n}`},1e3)}_stopTimer(e){this._timers&&this._timers[e]&&(clearInterval(this._timers[e]),delete this._timers[e]);const t=document.getElementById(e);t&&(t.style.display="none",t.textContent="00:00")}_updateFloatBar(e){const t=document.getElementById("instructor-float-bar"),i=document.getElementById("float-mode-label"),s=document.getElementById("float-mode-text");if(!t)return;t.classList.add("visible");const n={video:{cls:"mode-video",icon:"fa-video",text:"فيديو"},link:{cls:"mode-video",icon:"fa-link",text:"رابط"},live:{cls:"mode-live",icon:"fa-satellite-dish",text:"بث حي"},slides:{cls:"mode-slides",icon:"fa-images",text:"شرائح"},audio:{cls:"mode-audio",icon:"fa-podcast",text:"صوت فقط"},channel:{cls:"mode-channel",icon:"fa-bullhorn",text:"قناة"}},o=n[e]||n.video;i&&(i.className=`float-bar-mode-label ${o.cls}`,i.innerHTML=`<i class="fas ${o.icon}"></i>`),s&&(s.textContent=o.text);const a=document.getElementById("float-btn-mic"),r=document.getElementById("float-btn-cam"),l=document.getElementById("float-btn-stop");a&&(a.style.display="none"),r&&(r.style.display="none"),l&&(l.style.display="none"),e==="live"?(a&&(a.style.display="inline-flex"),r&&(r.style.display="inline-flex"),l&&(l.style.display="inline-flex")):e==="audio"&&(a&&(a.style.display="inline-flex"),l&&(l.style.display="inline-flex"))}_wireFloatBar(){const e=document.getElementById("float-btn-mic"),t=document.getElementById("float-btn-cam"),i=document.getElementById("float-btn-stop");e&&e.addEventListener("click",()=>window.InstructorAPI.toggleAgoraMic()),t&&t.addEventListener("click",()=>window.InstructorAPI.switchAgoraCamera()),i&&i.addEventListener("click",async()=>{const s=document.getElementById("float-mode-text")?.textContent;s==="بث حي"?window.InstructorAPI.stopAgoraLiveDedicated():s==="صوت فقط"?window.InstructorAPI.stopAudioOnly():s==="شرائح"&&window.InstructorAPI.stopSlidesAudio()})}},A=new L,T=class{init(e){this.controller=e}async setMode(e,t={}){const i={mode:e,metadata:t};await w.updateTeachingMode(this.controller.engine.courseId,i)}},p=new T,P=class{constructor(){this.controller=null}init(e){this.controller=e,this.attachListeners()}attachListeners(){const e=document.getElementById("inst-toggle-chat"),t=document.getElementById("inst-toggle-resources");e&&e.addEventListener("change",async i=>{const s=i.target.checked;await w.updateClassroomState(this.controller.engine.courseId,{chatLocked:s})}),t&&t.addEventListener("change",async i=>{const s=i.target.checked;await w.updateClassroomState(this.controller.engine.courseId,{resourcesLocked:s})})}},R=new P,V=class{constructor(){this.controller=null,this.unsubscribe=null}init(e){this.controller=e,this.startListening()}startListening(){this.activeStudentsMap=new Map,this.unsubscribe=k.listenToActiveUsers(this.controller.engine.courseId,e=>{const t=document.getElementById("instructor-student-list");if(!t)return;const i=Date.now(),s=[];if(this.activeStudentsMap.clear(),e.forEach(o=>{if(o.lastSeen){const a=o.lastSeen.toMillis?o.lastSeen.toMillis():i;i-a<9e4&&(s.push(o),o.userId&&this.activeStudentsMap.set(o.userId,o))}else s.push(o),o.userId&&this.activeStudentsMap.set(o.userId,o)}),s.length===0){t.innerHTML='<div style="text-align: center; padding: 2rem; color: var(--text-secondary); background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06); border-radius: 12px;">لا يوجد طلاب متصلين حالياً.</div>';return}const n=document.createDocumentFragment();s.forEach(o=>{const a=document.createElement("div");a.style.cssText="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 1rem; padding: 1rem; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 10px;",a.innerHTML=`
                ...
                `,n.appendChild(a)}),t.innerHTML="",t.appendChild(n),this.delegationAdded||(t.addEventListener("click",o=>{const a=o.target.closest(".btn-student-details");if(a){const d=a.getAttribute("data-uid"),c=this.activeStudentsMap.get(d);c&&this.showDetailsModal(c);return}const r=o.target.closest(".btn-student-unmute");if(r){const d=r.getAttribute("data-uid"),c=this.activeStudentsMap.get(d);confirm("هل تريد السماح لهذا الطالب بالتحدث وإعطائه المايك؟")&&this.controller.allowStudentMic(d,c?c.name:"الطالب");return}const l=o.target.closest(".btn-student-mute");if(l){const d=l.getAttribute("data-uid");confirm("هل أنت متأكد من سحب صلاحية الميكروفون من هذا الطالب؟")&&this.controller.revokeStudentMic(d);return}const u=o.target.closest(".btn-student-kick");if(u){const d=u.getAttribute("data-uid");confirm("هل أنت متأكد من طرد هذا الطالب من الغرفة؟")&&this.controller.kickStudent(d);return}}),this.delegationAdded=!0)})}showDetailsModal(e){let t=document.getElementById("inst-student-details-modal");t||(t=document.createElement("div"),t.id="inst-student-details-modal",t.style.cssText="position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:99999; display:flex; align-items:center; justify-content:center;",t.innerHTML=`
            ...
            `,document.body.appendChild(t),document.getElementById("inst-student-close-btn").addEventListener("click",()=>{t.style.display="none"}),t.addEventListener("click",s=>{s.target===t&&(t.style.display="none")}));const i=document.getElementById("inst-student-details-content");i.innerHTML=`
        ...
        `,t.style.display="flex"}destroy(){this.unsubscribe&&this.unsubscribe();const e=document.getElementById("inst-student-details-modal");e&&e.remove()}},O=new V,z=class{init(e){this.controller=e}},D=new z,N=class{constructor(){this.controller=null,this.unsubscribePresence=null,this.onlineCount=0}init(e){this.controller=e,this.startListening()}startListening(){const e=this.controller.engine.courseId;this.unsubscribePresence=k.listenToActiveUsers(e,t=>{const i=Date.now();let s=0;t.forEach(n=>{if(n.lastSeen){const o=n.lastSeen.toMillis?n.lastSeen.toMillis():i;i-o<9e4&&s++}else s++}),this.onlineCount=s,this.updateUI()})}updateUI(){const e=document.getElementById("inst-stat-online");e&&(e.innerText=this.onlineCount)}destroy(){this.unsubscribePresence&&this.unsubscribePresence()}},H=new N,U=class{constructor(){this.engine=null,this.isInitialized=!1,this.activeSessionsUnsubscribe=null,this.activeLessonId=null}init(e){if(!this.isInitialized){if(this.engine=e,!this.engine.isInstructor){console.error("SECURITY VIOLATION: Non-instructor attempting to initialize InstructorController.");return}M.subscribe(C.PLAY_LECTURE,t=>{t&&t.id&&(this.activeLessonId=t.id)}),A.init(this),p.init(this),R.init(this),O.init(this),D.init(this),H.init(this),this.isInitialized=!0,this.restoreVideoManagementPanel(),this.listenForHandRaises()}}async updateProfile(e){try{await w.updateProfile(this.engine.currentUser.uid,e),await w.updateCourseProfile(this.engine.courseId,e)}catch(t){throw console.error("Profile update failed",t),t}}async promptVideoUpload(){const e=document.createElement("input");e.type="file",e.accept="video/mp4,video/webm,video/ogg",e.onchange=async t=>{const i=t.target.files[0];if(!i)return;const s=document.getElementById("btn-video-upload");s&&(s.disabled=!0,s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الرفع...');try{const n=await w.uploadMedia(i,`courses/${this.engine.courseId}/videos`);await v.updateCourse(this.engine.courseId,{activeVideoUrl:n}),await p.setMode("video",{isLive:!1,videoUrl:n,status:"playing",timestamp:0}),this._showVideoManagementPanel(n,i.name)}catch(n){alert("فشل رفع الفيديو: "+n.message)}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fas fa-upload"></i> رفع فيديو')}},e.click()}async deleteVideo(){try{const e=(await v.getCourse(this.engine.courseId))?.activeVideoUrl;if(e)try{await S.deleteStorageObjectByUrl(e),console.log("[InstructorController] Deleted temporary active video file")}catch(t){console.warn("[InstructorController] Storage delete failed (may have already been removed):",t.message)}await v.clearActiveVideo(this.engine.courseId),await p.setMode("video",{isLive:!1,videoUrl:null,status:"paused"}),this._hideVideoManagementPanel()}catch(e){alert("فشل حذف الفيديو: "+e.message)}}async replaceVideo(){try{const e=(await v.getCourse(this.engine.courseId))?.activeVideoUrl;if(e)try{await S.deleteStorageObjectByUrl(e),console.log("[InstructorController] Deleted temporary active video file")}catch(t){console.warn("[InstructorController] Could not delete video file from storage",t)}}catch{}this.promptVideoUpload()}_showVideoManagementPanel(e,t){const i=document.getElementById("video-management-panel");if(!i)return;const s=document.getElementById("current-video-name"),n=document.getElementById("current-video-preview");s&&(s.textContent=t||"فيديو محمّل"),n&&(n.src=e,this._attachVideoSyncListeners(n)),i.style.display="block",i.style.animation="fadeIn 0.3s ease"}_attachVideoSyncListeners(e){this._removeVideoSyncListeners(),this._videoTarget=e,this._videoHandlers={play:()=>p.setMode("video",{status:"playing",timestamp:e.currentTime}),pause:()=>p.setMode("video",{status:"paused",timestamp:e.currentTime}),seeked:()=>p.setMode("video",{timestamp:e.currentTime}),timeupdate:(()=>{let t=0;return()=>{const i=Date.now();i-t>2e3&&!e.paused&&(p.setMode("video",{status:"playing",timestamp:e.currentTime}),t=i)}})()},this._videoTarget&&(this._videoTarget.addEventListener("play",this._videoHandlers.play),this._videoTarget.addEventListener("pause",this._videoHandlers.pause),this._videoTarget.addEventListener("seeked",this._videoHandlers.seeked),this._videoTarget.addEventListener("timeupdate",this._videoHandlers.timeupdate))}_removeVideoSyncListeners(){this._videoTarget&&this._videoHandlers&&(this._videoTarget.removeEventListener("play",this._videoHandlers.play),this._videoTarget.removeEventListener("pause",this._videoHandlers.pause),this._videoTarget.removeEventListener("seeked",this._videoHandlers.seeked),this._videoTarget.removeEventListener("timeupdate",this._videoHandlers.timeupdate)),this._videoHandlers=null,this._videoTarget=null}_hideVideoManagementPanel(){const e=document.getElementById("video-management-panel");e&&(e.style.display="none"),this._removeVideoSyncListeners()}async restoreVideoManagementPanel(){try{const e=(await v.getCourse(this.engine.courseId))?.activeVideoUrl;e&&this._showVideoManagementPanel(e,"فيديو محمّل مسبقاً")}catch{}}async playVideo(){const e=document.getElementById("current-video-preview");e&&e.play().catch(t=>console.warn("Play prevented",t))}async pauseVideo(){const e=document.getElementById("current-video-preview");e&&e.pause()}async startAgoraLive(){try{const{MediaEngine:e}=await m(async()=>{const{MediaEngine:t}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:t}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));await e.startLiveWebRTC(this.engine.courseId),await p.setMode("live",{isLive:!0})}catch(e){console.error("[InstructorController] Failed to start live stream:",e);const{NotificationManager:t}=await m(async()=>{const{NotificationManager:i}=await import("./NotificationManager-DMg0JkUo.js").then(s=>s.n);return{NotificationManager:i}},__vite__mapDeps([5,2]));throw t.show("تعذر بدء البث المباشر: "+e.message,"error"),e}}async stopAgoraLive(){const{MediaEngine:e}=await m(async()=>{const{MediaEngine:t}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:t}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));await p.setMode("video",{isLive:!1}),e.stopLiveWebRTC(this.engine.courseId)}async toggleAgoraMic(){const{MediaEngine:e}=await m(async()=>{const{MediaEngine:i}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:i}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16])),t=e.toggleMic();document.getElementById("btn-agora-mic").innerHTML=t?'<i class="fas fa-microphone-slash"></i> تم الكتم':'<i class="fas fa-microphone"></i> كتم المايك'}async switchAgoraCamera(){const{MediaEngine:e}=await m(async()=>{const{MediaEngine:t}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:t}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));e.switchCamera()}async setTeachingMode(e,t={}){const{MediaEngine:i}=await m(async()=>{const{MediaEngine:r}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:r}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));this.isSlidesAudioActive=!1;const s=document.getElementById("btn-slides-mic-start"),n=document.getElementById("btn-slides-mic-stop");s&&(s.style.display="inline-block"),n&&(n.style.display="none"),this.isAudioOnlyActive=!1;const o=document.getElementById("btn-audio-start"),a=document.getElementById("btn-audio-stop");if(o&&(o.style.display="inline-block"),a&&(a.style.display="none"),i.agoraClient||i._isPublishing)try{await i.stopLiveWebRTC(this.engine.courseId)}catch{}await p.setMode(e,t),e==="slides"&&this.loadSlidesGallery()}async loadSlidesGallery(){try{const e=await v.getCourse(this.engine.courseId)||{};this.courseSlides=e.slidesGallery||[],this.renderSlidesGallery()}catch(e){console.error("Failed to load slides gallery",e)}}renderSlidesGallery(){const e=document.getElementById("inst-slides-gallery");e&&(e.innerHTML="",this.selectedSlides=[],this.courseSlides.forEach((t,i)=>{const s=document.createElement("img");s.src=t,s.style.width="100%",s.style.height="60px",s.style.objectFit="cover",s.style.borderRadius="4px",s.style.cursor="pointer",s.style.border="2px solid transparent",s.onclick=()=>{if(this.selectedSlides.includes(t))this.selectedSlides=this.selectedSlides.filter(n=>n!==t),s.style.borderColor="transparent";else{const n=document.getElementById("inst-slides-layout"),o=n?n.value:"slides-layout-1";let a=1;if(o==="slides-layout-2"?a=2:o==="slides-layout-3"?a=3:o==="slides-layout-4"?a=4:o==="slides-layout-5"&&(a=5),this.selectedSlides.length>=a){const r=this.selectedSlides.shift();e.querySelectorAll("img").forEach(l=>{l.src===r&&(l.style.borderColor="transparent")})}this.selectedSlides.push(t),s.style.borderColor="#34d399"}},e.appendChild(s)}))}async uploadSlides(e){const t=Array.from(e.target.files);if(t.length)try{const i=t.map(n=>w.uploadMedia(n,`courses/${this.engine.courseId}/slides`)),s=await Promise.all(i);await v.addSlidesToGallery(this.engine.courseId,s),await this.loadSlidesGallery(),alert("تم رفع الصور بنجاح.")}catch(i){console.error("Failed to upload slides:",i),alert("فشل رفع الصور: "+i.message)}}handleSlideLayoutChange(e){const t=e.target.value;let i=1;if(t==="slides-layout-2"?i=2:t==="slides-layout-3"?i=3:t==="slides-layout-4"?i=4:t==="slides-layout-5"&&(i=5),this.selectedSlides&&this.selectedSlides.length>i){const s=this.selectedSlides.length-i,n=this.selectedSlides.splice(0,s),o=document.getElementById("inst-slides-gallery");o&&o.querySelectorAll("img").forEach(a=>{n.includes(a.src)&&(a.style.borderColor="transparent")})}}async presentSelectedSlides(){if(!this.selectedSlides||this.selectedSlides.length===0){alert("يرجى اختيار صورة واحدة على الأقل للعرض.");return}const e=document.getElementById("inst-slides-layout"),t=e?e.value:"slides-layout-1";await p.setMode("slides",{slides:this.selectedSlides,layout:t,audioStream:this.isSlidesAudioActive||!1})}async startSlidesAudio(){const{MediaEngine:e}=await m(async()=>{const{MediaEngine:t}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:t}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));this.isSlidesAudioActive=!0,document.getElementById("btn-slides-mic-start").style.display="none",document.getElementById("btn-slides-mic-stop").style.display="block",await p.setMode("slides",{slides:this.selectedSlides||[],layout:document.getElementById("inst-slides-layout")?.value||"slides-layout-1",audioStream:!0}),e.startAudioOnlyWebRTC(this.engine.courseId)}async stopSlidesAudio(){const{MediaEngine:e}=await m(async()=>{const{MediaEngine:t}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:t}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));this.isSlidesAudioActive=!1,document.getElementById("btn-slides-mic-start").style.display="block",document.getElementById("btn-slides-mic-stop").style.display="none",await p.setMode("slides",{slides:this.selectedSlides||[],layout:document.getElementById("inst-slides-layout")?.value||"slides-layout-1",audioStream:!1}),e.stopLiveWebRTC(this.engine.courseId)}async startAudioOnly(){const{MediaEngine:e}=await m(async()=>{const{MediaEngine:t}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:t}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));this.isAudioOnlyActive=!0,document.getElementById("btn-audio-start").style.display="none",document.getElementById("btn-audio-stop").style.display="block",await p.setMode("audio",{audioStream:!0}),e.startAudioOnlyWebRTC(this.engine.courseId)}async stopAudioOnly(){const{MediaEngine:e}=await m(async()=>{const{MediaEngine:t}=await import("./MediaEngine-MRBtyyxG.js");return{MediaEngine:t}},__vite__mapDeps([15,4,2,9,6,3,7,1,5,8,10,11,12,13,14,16]));this.isAudioOnlyActive=!1,document.getElementById("btn-audio-start").style.display="block",document.getElementById("btn-audio-stop").style.display="none",await p.setMode("audio",{audioStream:!1}),e.stopLiveWebRTC(this.engine.courseId)}async sendChannelMessage(){const e=document.getElementById("inst-channel-text");if(!e||!e.value.trim())return;const t=e.value.trim();e.value="";const i={type:"text",content:t,timestamp:Date.now()};try{const{InstructorService:s}=await m(async()=>{const{InstructorService:n}=await import("./InstructorService-DFH8LYX2.js");return{InstructorService:n}},[]);await s.addChannelMessage(this.engine.courseId,this.activeLessonId,i),await p.setMode("channel",{lastMessage:i})}catch(s){console.error("Failed to send channel text:",s)}}async sendChannelImage(e){const t=e.target.files[0];if(t){e.target.value="";try{const{InstructorService:i}=await m(async()=>{const{InstructorService:n}=await import("./InstructorService-DFH8LYX2.js");return{InstructorService:n}},[]),s={type:"image",content:await i.uploadMedia(t,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await i.addChannelMessage(this.engine.courseId,this.activeLessonId,s),await p.setMode("channel",{lastMessage:s})}catch(i){console.error("Failed to upload channel image:",i),alert("فشل رفع الصورة: "+i.message)}}}async sendChannelVideo(e){const t=e.target.files[0];if(t){e.target.value="";try{const{InstructorService:i}=await m(async()=>{const{InstructorService:n}=await import("./InstructorService-DFH8LYX2.js");return{InstructorService:n}},[]),s={type:"video",content:await i.uploadMedia(t,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await i.addChannelMessage(this.engine.courseId,this.activeLessonId,s),await p.setMode("channel",{lastMessage:s})}catch(i){console.error("Failed to upload channel video:",i),alert("فشل رفع الفيديو: "+i.message)}}}async toggleChannelVoice(){const e=document.getElementById("btn-channel-voice");if(this.isRecordingVoice)this.mediaRecorder.stop(),this.audioStream.getTracks().forEach(t=>t.stop()),this.audioCtx&&(this.audioCtx.close().catch(t=>console.warn(t)),this.audioCtx=null),this.isRecordingVoice=!1,e.innerHTML='<i class="fas fa-microphone"></i> تسجيل صوتي',e.classList.replace("btn-danger","btn-dark"),this.audioStream&&(this.audioStream.getTracks().forEach(t=>t.stop()),this.audioStream=null);else try{this.audioStream=await navigator.mediaDevices.getUserMedia({audio:{noiseSuppression:!0,echoCancellation:!0,autoGainControl:!0,channelCount:1,sampleRate:44100}});const t=window.AudioContext||window.webkitAudioContext;this.audioCtx=new t;const i=this.audioCtx.createMediaStreamSource(this.audioStream),s=this.audioCtx.createBiquadFilter();s.type="highpass",s.frequency.value=85;const n=this.audioCtx.createBiquadFilter();n.type="lowpass",n.frequency.value=9e3;const o=this.audioCtx.createDynamicsCompressor();o.threshold.value=-40,o.knee.value=30,o.ratio.value=10,o.attack.value=.005,o.release.value=.1,i.connect(s),s.connect(n),n.connect(o);const a=this.audioCtx.createMediaStreamDestination();o.connect(a),this.mediaRecorder=new MediaRecorder(a.stream),this.audioChunks=[],this.mediaRecorder.ondataavailable=r=>{r.data.size>0&&this.audioChunks.push(r.data)},this.mediaRecorder.onstop=async()=>{const r=new Blob(this.audioChunks,{type:"audio/webm"}),l=new File([r],`audio_${Date.now()}.webm`,{type:"audio/webm"});try{const{InstructorService:u}=await m(async()=>{const{InstructorService:c}=await import("./InstructorService-DFH8LYX2.js");return{InstructorService:c}},[]),d={type:"audio",content:await u.uploadMedia(l,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await u.addChannelMessage(this.engine.courseId,this.activeLessonId,d),await p.setMode("channel",{lastMessage:d})}catch(u){console.error("Failed to upload audio:",u);const{NotificationManager:d}=await m(async()=>{const{NotificationManager:c}=await import("./NotificationManager-DMg0JkUo.js").then(y=>y.n);return{NotificationManager:c}},__vite__mapDeps([5,2]));d.show("فشل رفع المقطع الصوتي: "+u.message,"error")}},this.mediaRecorder.start(),this.isRecordingVoice=!0,e.innerHTML='<i class="fas fa-stop-circle"></i> إيقاف التسجيل',e.classList.replace("btn-dark","btn-danger")}catch(t){console.error("Error accessing microphone:",t);const{NotificationManager:i}=await m(async()=>{const{NotificationManager:s}=await import("./NotificationManager-DMg0JkUo.js").then(n=>n.n);return{NotificationManager:s}},__vite__mapDeps([5,2]));i.show("لم نتمكن من الوصول إلى الميكروفون. يرجى التأكد من منح الصلاحيات.","error")}}showHandRaiseNotification(e,t){const i=document.getElementById("hand-raise-toasts");if(!i)return;const s=document.createElement("div");s.className="hand-raise-toast",s.dataset.uid=t,s.innerHTML=`
        ...
        `,s.querySelector(".toast-allow-btn").addEventListener("click",()=>{this.allowStudentMic(t,e),s.remove()}),i.appendChild(s),setTimeout(()=>{s.parentNode&&s.remove()},15e3)}async allowStudentMic(e,t){try{await x.setSessionState(this.engine.courseId,{[`micPermissions.${e}`]:!0});const{NotificationManager:i}=await m(async()=>{const{NotificationManager:s}=await import("./NotificationManager-DMg0JkUo.js").then(n=>n.n);return{NotificationManager:s}},__vite__mapDeps([5,2]));i.show(`تم السماح لـ ${t} بالكلام`,"success")}catch(i){console.error("[InstructorController] allowStudentMic failed:",i)}}async revokeStudentMic(e){try{await x.revokeMicPermission(this.engine.courseId,e),NotificationManager.show("تم سحب صلاحية الميكروفون بنجاح","success")}catch(t){console.error("[InstructorController] revoke mic error",t),NotificationManager.show("حدث خطأ أثناء سحب الصلاحية","error")}}async kickStudent(e){try{await x.kickStudent(this.engine.courseId,e),NotificationManager.show("تم طرد الطالب من الغرفة بنجاح","success")}catch(t){console.error("[InstructorController] kick student error",t),NotificationManager.show("حدث خطأ أثناء محاولة طرد الطالب","error")}}listenForHandRaises(){this._handRaiseUnsubscribe=x.onHandRaisesSnapshot(this.engine.courseId,e=>{e.forEach(t=>{if(t.type==="added"){const i=t.doc.data();this.showHandRaiseNotification(i.name||"طالب",t.doc.id)}})})}showHandRaiseNotification(e,t){const i=document.getElementById("hand-raise-toasts");if(!i)return;const s=document.createElement("div");s.className="hand-raise-toast",s.style.cssText="background:rgba(0,0,0,0.8); border:1px solid var(--primary-color); border-radius:10px; padding:1rem; display:flex; flex-direction:column; gap:0.5rem; animation: slideInRight 0.3s ease;",s.innerHTML=`
            ...
            <div style="display:flex; gap:0.5rem; margin-top:0.5rem;">
                <button class="btn btn-sm btn-primary" style="flex:1;" onclick="InstructorController.handleHandRaise('${t}', '${e}', true, this.parentElement.parentElement)">قبول</button>
                <button class="btn btn-sm btn-dark" style="flex:1;" onclick="InstructorController.handleHandRaise('${t}', '${e}', false, this.parentElement.parentElement)">رفض</button>
            </div>
        `,i.appendChild(s),setTimeout(()=>{s.parentElement&&(s.style.animation="slideOutRight 0.3s ease forwards",setTimeout(()=>s.remove(),300),x.cancelMicRequest(this.engine.courseId,t).catch(()=>{}))},2e4)}async handleHandRaise(e,t,i,s){s&&(s.style.animation="slideOutRight 0.3s ease forwards",setTimeout(()=>s.remove(),300));try{await x.cancelMicRequest(this.engine.courseId,e),i&&await this.allowStudentMic(e,t)}catch(n){console.error("[InstructorController] handleHandRaise error:",n)}}destroy(){this._handRaiseUnsubscribe&&(this._handRaiseUnsubscribe(),this._handRaiseUnsubscribe=null),this.activeSessionsUnsubscribe&&(this.activeSessionsUnsubscribe(),this.activeSessionsUnsubscribe=null),this._removeVideoSyncListeners(),this.isInitialized=!1,this.engine=null}},Y=new U;export{Y as InstructorController,_ as n,w as t};
