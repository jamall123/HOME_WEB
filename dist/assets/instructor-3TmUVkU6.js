const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CommandBus-DDWs6bw7.js","assets/UserRepository-BRTpWXZO.js","assets/rolldown-runtime-BQ-_32WO.js","assets/CourseRepository-f1jNkUKg.js","assets/courseRoom-CkEL-BXf.js","assets/firebase-config-CVzH6vXx.js","assets/EventBus-DfwAvCQ6.js","assets/NotificationManager-yG1gWUIM.js","assets/preload-helper-BATLnrmA.js","assets/CurriculumRepository-Bni9Hoox.js","assets/CurriculumProgress-CoYmvyaE.js","assets/StudentProgressRepository-Dqxg6lR-.js","assets/courseRoom-BrFk4XgN.css","assets/sudanFree-CgE2LGLP.css","assets/MediaEngine-DrsiXtmw.js","assets/MediaRepository-BI-9cctR.js"])))=>i.map(i=>d[i]);
import{n as u,r as f,t as g}from"./CourseRepository-f1jNkUKg.js";import{t as l}from"./preload-helper-BATLnrmA.js";import{i as k,t as x}from"./courseRoom-CkEL-BXf.js";import{t as S}from"./MediaRepository-BI-9cctR.js";import"./InstructorAnalyticsUI-CDRbRYn3.js";var p={get db(){return f.getFirestore()},get storage(){return f.getStorage()},async updateProfile(e,t){if(!e)throw new Error("No UID provided");await this.db.collection(u.COLLECTIONS.USERS).doc(e).set(t,{merge:!0})},async updateCourseProfile(e,t){if(!e)throw new Error("No courseId provided");await this.db.collection(u.COLLECTIONS.COURSES).doc(e).set({instructor:t.name||null,instructorSpecialty:t.specialty||null,instructorBio:t.bio||null,instructorPhoto:t.photo||null},{merge:!0})},uploadMedia(e,t,s=null){return new Promise((i,n)=>{const o=this.storage.ref().child(`${t}/${Date.now()}_${e.name}`).put(e);o.on("state_changed",a=>{s&&s(a.bytesTransferred/a.totalBytes*100)},a=>n(a),async()=>{i(await o.snapshot.ref.getDownloadURL())})})},async updateTeachingMode(e,t){const s={updatedAt:f.getFirestoreFieldValue().serverTimestamp()};for(const[i,n]of Object.entries(t))if(i==="metadata"&&typeof n=="object")for(const[o,a]of Object.entries(n))s[`metadata.${o}`]=a;else s[i]=n;try{await this.db.collection(u.COLLECTIONS.ACTIVE_SESSIONS).doc(e).update(s)}catch{const n={...t,updatedAt:f.getFirestoreFieldValue().serverTimestamp()};await this.db.collection(u.COLLECTIONS.ACTIVE_SESSIONS).doc(e).set(n,{merge:!0})}},async addChannelMessage(e,t){if(!e)throw new Error("No courseId provided");await this.db.collection(u.COLLECTIONS.COURSES).doc(e).collection(u.COLLECTIONS.CHANNEL_MESSAGES).add(t)},async updateClassroomState(e,t){await this.db.collection(u.COLLECTIONS.ACTIVE_SESSIONS).doc(e).set({permissions:t,updatedAt:f.getFirestoreFieldValue().serverTimestamp()},{merge:!0})},async getResources(e){return(await this.db.collection(u.COLLECTIONS.LESSON_RESOURCES).where("courseId","==",e).get()).docs.map(t=>({id:t.id,...t.data()}))},async dispatchCommand(e){const{commandBus:t}=await l(async()=>{const{commandBus:s}=await import("./CommandBus-DDWs6bw7.js");return{commandBus:s}},__vite__mapDeps([0,1,2,3]));return t.dispatch(e)},async postAnnouncement(e,t){await this.db.collection(u.COLLECTIONS.LESSON_ANNOUNCEMENTS).add({courseId:e,...t,timestamp:f.getFirestoreFieldValue().serverTimestamp()})}},M=class{constructor(){}async updateProfile(e,t){await p.updateProfile(e,t)}async updateCourseProfile(e,t){await p.updateCourseProfile(e,t)}uploadMedia(e,t,s=null){return p.uploadMedia(e,t,s)}async updateTeachingMode(e,t){await p.updateTeachingMode(e,t)}async addChannelMessage(e,t){await p.addChannelMessage(e,t)}async updateClassroomState(e,t){await p.updateClassroomState(e,t)}async getResources(e){return await p.getResources(e)}async postAnnouncement(e,t){await p.postAnnouncement(e,t)}},y=new M,m={show({icon:e="📢",title:t="تأكيد",body:s="",okLabel:i="تأكيد",cancelLabel:n="إلغاء",danger:o=!1}={}){return new Promise(a=>{const r=document.getElementById("room-confirm-overlay"),d=document.getElementById("confirm-icon"),h=document.getElementById("confirm-title"),E=document.getElementById("confirm-body"),b=document.getElementById("confirm-ok-btn"),v=document.getElementById("confirm-cancel-btn");if(!r){a(!0);return}d&&(d.textContent=e),h&&(h.textContent=t),E&&(E.textContent=s),b&&(b.textContent=i),v&&(v.textContent=n),b&&(b.className=o?"btn-confirm-ok danger-ok":"btn-confirm-ok");const w=I=>{r.classList.remove("active"),b.onclick=null,v.onclick=null,a(I)};b.onclick=()=>w(!0),v.onclick=()=>w(!1),r.onclick=I=>{I.target===r&&w(!1)},r.classList.add("active")})},alert({icon:e="ℹ️",title:t="تنبيه",body:s="",okLabel:i="حسناً"}={}){return new Promise(n=>{const o=document.getElementById("room-confirm-overlay");if(!o){n();return}document.getElementById("confirm-icon").textContent=e,document.getElementById("confirm-title").textContent=t,document.getElementById("confirm-body").textContent=s,document.getElementById("confirm-ok-btn").textContent=i,document.getElementById("confirm-cancel-btn").style.display="none";const a=document.getElementById("confirm-ok-btn");a.className="btn-confirm-ok";const r=()=>{o.classList.remove("active"),a.onclick=null,document.getElementById("confirm-cancel-btn").style.display="",n()};a.onclick=()=>r(),o.onclick=d=>{d.target===o&&r()},o.classList.add("active")})}},C=class{init(e){this.controller=e,this.cacheDOM(),this.renderDashboardLayout(),this.attachListeners()}cacheDOM(){this.mountPoint=document.getElementById("instructor-dashboard-mount"),this.tabBtn=document.getElementById("tab-btn-instructor-side")}renderDashboardLayout(){this.mountPoint&&(this.tabBtn&&(this.tabBtn.style.display="flex"),this.mountPoint.innerHTML=`
...
هل أنت جاهز لبدء البث؟`,okLabel:"بدء البث"})&&(this.controller.startAgoraLive().catch(async s=>{await m.alert({icon:"❌",title:"خطأ",body:"تعذر بدء البث: "+s.message})}),document.getElementById("btn-start-agora-live").style.display="none",document.getElementById("btn-stop-agora-live").style.display="block",document.getElementById("live-on-badge").style.display="inline",document.getElementById("live-ws-status").textContent="البث نشط الآن",document.getElementById("float-btn-mic").style.display="inline-flex",document.getElementById("float-btn-cam").style.display="inline-flex",document.getElementById("float-btn-stop").style.display="inline-flex",this._startTimer("live-ws-timer"))},stopAgoraLiveDedicated:async()=>{await m.show({icon:"⏹",title:"إنهاء البث",body:"هل تريد إنهاء البث الحي الآن؟",okLabel:"إنهاء البث",danger:!0})&&(this.controller.stopAgoraLive(),document.getElementById("btn-start-agora-live").style.display="block",document.getElementById("btn-stop-agora-live").style.display="none",document.getElementById("live-on-badge").style.display="none",document.getElementById("live-ws-status").textContent="البث غير نشط حالياً",document.getElementById("float-btn-mic").style.display="none",document.getElementById("float-btn-cam").style.display="none",document.getElementById("float-btn-stop").style.display="none",this._stopTimer("live-ws-timer"))},toggleAgoraMic:async()=>{const{MediaEngine:s}=await l(async()=>{const{MediaEngine:a}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:a}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15])),i=s.toggleMic(),n=["btn-agora-mic","btn-live-mic"],o=document.getElementById("float-btn-mic");n.forEach(a=>{const r=document.getElementById(a);r&&(r.innerHTML=i?'<i class="fas fa-microphone-slash"></i> مكتوم':'<i class="fas fa-microphone"></i> المايك',i?r.classList.add("btn-danger"):r.classList.remove("btn-danger"))}),o&&(o.innerHTML=i?'<i class="fas fa-microphone-slash"></i><span class="fb-label"> مكتوم</span>':'<i class="fas fa-microphone"></i><span class="fb-label"> المايك</span>',i?o.classList.add("active"):o.classList.remove("active"))},switchAgoraCamera:async()=>{const{MediaEngine:s}=await l(async()=>{const{MediaEngine:i}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:i}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));s.switchCamera()},sendChannelMessage:async()=>{const s=document.getElementById("inst-channel-text"),i=s?s.value.trim():"";if(!i){await m.alert({icon:"✏️",title:"الرسالة فارغة",body:"يرجى كتابة رسالة قبل الإرسال."});return}await m.show({icon:"📢",title:"تأكيد إرسال الرسالة",body:i.length>120?i.slice(0,120)+"...":i,okLabel:"إرسال"})&&this.controller.sendChannelMessage()},sendChannelImage:async s=>{const i=s.target.files[0];i&&(await m.show({icon:"🖼️",title:"إرسال صورة",body:`هل تريد إرسال الصورة "${i.name}" للطلاب؟`,okLabel:"إرسال الصورة"})?this.controller.sendChannelImage(s):s.target.value="")},sendChannelVideo:async s=>{const i=s.target.files[0];i&&(await m.show({icon:"🎬",title:"إرسال فيديو",body:`هل تريد إرسال الفيديو "${i.name}" للطلاب؟`,okLabel:"إرسال الفيديو"})?this.controller.sendChannelVideo(s):s.target.value="")},toggleChannelVoice:()=>this.controller.toggleChannelVoice()},this._wireFloatBar(),this._updateFloatBar("video");const e=this.mountPoint.querySelectorAll(".inst-nav");e.forEach(s=>{s.addEventListener("click",i=>{const n=i.currentTarget.getAttribute("data-view");e.forEach(a=>{a.classList.remove("btn-primary"),a.classList.add("btn-dark")}),i.currentTarget.classList.remove("btn-dark"),i.currentTarget.classList.add("btn-primary"),this.mountPoint.querySelectorAll(".inst-view").forEach(a=>a.style.display="none");const o=this.mountPoint.querySelector(`#inst-view-${n}`);o&&(o.style.display="flex"),n==="dashboard"&&o&&(o.style.flexDirection="column")})});const t=this.mountPoint.querySelector("#inst-profile-form");t&&t.addEventListener("submit",async s=>{s.preventDefault();const i=t.querySelector('button[type="submit"]'),n=i.innerHTML;i.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...',i.disabled=!0;const o={name:document.getElementById("inst-prof-name").value.trim(),specialty:document.getElementById("inst-prof-spec").value.trim(),bio:document.getElementById("inst-prof-bio").value.trim()},a=document.getElementById("inst-prof-photo").files[0],r=document.getElementById("inst-prof-cv").files[0];try{const{InstructorService:d}=await l(async()=>{const{InstructorService:h}=await import("./InstructorService-JteGwn_z.js");return{InstructorService:h}},[]);a&&(i.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري رفع الصورة...',o.photo=await d.uploadMedia(a,`profiles/${this.controller.engine.currentUser.uid}`)),r&&(i.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري رفع السيرة...',o.cv=await d.uploadMedia(r,`profiles/${this.controller.engine.currentUser.uid}`)),i.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...',await this.controller.updateProfile(o),i.innerHTML='<i class="fas fa-check"></i> تم الحفظ بنجاح',setTimeout(()=>{i.innerHTML=n,i.disabled=!1},3e3)}catch(d){await m.alert({icon:"❌",title:"خطأ",body:"حدث خطأ: "+(d.message||"")}),i.innerHTML=n,i.disabled=!1}})}_startTimer(e){this._stopTimer(e);const t=document.getElementById(e);if(!t)return;t.style.display="block";let s=0;this._timers=this._timers||{},this._timers[e]=setInterval(()=>{s++;const i=String(Math.floor(s/60)).padStart(2,"0"),n=String(s%60).padStart(2,"0");t.textContent=`${i}:${n}`},1e3)}_stopTimer(e){this._timers&&this._timers[e]&&(clearInterval(this._timers[e]),delete this._timers[e]);const t=document.getElementById(e);t&&(t.style.display="none",t.textContent="00:00")}_updateFloatBar(e){const t=document.getElementById("instructor-float-bar"),s=document.getElementById("float-mode-label"),i=document.getElementById("float-mode-text");if(!t)return;t.classList.add("visible");const n={video:{cls:"mode-video",icon:"fa-video",text:"فيديو"},link:{cls:"mode-video",icon:"fa-link",text:"رابط"},live:{cls:"mode-live",icon:"fa-satellite-dish",text:"بث حي"},slides:{cls:"mode-slides",icon:"fa-images",text:"شرائح"},audio:{cls:"mode-audio",icon:"fa-podcast",text:"صوت فقط"},channel:{cls:"mode-channel",icon:"fa-bullhorn",text:"قناة"}},o=n[e]||n.video;s&&(s.className=`float-bar-mode-label ${o.cls}`,s.innerHTML=`<i class="fas ${o.icon}"></i>`),i&&(i.textContent=o.text);const a=document.getElementById("float-btn-mic"),r=document.getElementById("float-btn-cam"),d=document.getElementById("float-btn-stop");a&&(a.style.display="none"),r&&(r.style.display="none"),d&&(d.style.display="none"),e==="live"?(a&&(a.style.display="inline-flex"),r&&(r.style.display="inline-flex"),d&&(d.style.display="inline-flex")):e==="audio"&&(a&&(a.style.display="inline-flex"),d&&(d.style.display="inline-flex"))}_wireFloatBar(){const e=document.getElementById("float-btn-mic"),t=document.getElementById("float-btn-cam"),s=document.getElementById("float-btn-stop");e&&e.addEventListener("click",()=>window.InstructorAPI.toggleAgoraMic()),t&&t.addEventListener("click",()=>window.InstructorAPI.switchAgoraCamera()),s&&s.addEventListener("click",async()=>{const i=document.getElementById("float-mode-text")?.textContent;i==="بث حي"?window.InstructorAPI.stopAgoraLiveDedicated():i==="صوت فقط"?window.InstructorAPI.stopAudioOnly():i==="شرائح"&&window.InstructorAPI.stopSlidesAudio()})}},A=new C,B=class{init(e){this.controller=e}async setMode(e,t={}){const s={mode:e,metadata:t};await y.updateTeachingMode(this.controller.engine.courseId,s)}},c=new B,L=class{constructor(){this.controller=null}init(e){this.controller=e,this.attachListeners()}attachListeners(){const e=document.getElementById("inst-toggle-chat"),t=document.getElementById("inst-toggle-resources");e&&e.addEventListener("change",async s=>{const i=s.target.checked;await y.updateClassroomState(this.controller.engine.courseId,{chatLocked:i})}),t&&t.addEventListener("change",async s=>{const i=s.target.checked;await y.updateClassroomState(this.controller.engine.courseId,{resourcesLocked:i})})}},_=new L,T=class{constructor(){this.controller=null,this.unsubscribe=null}init(e){this.controller=e,this.startListening()}startListening(){this.unsubscribe=k.listenToActiveUsers(this.controller.engine.courseId,e=>{const t=document.getElementById("instructor-student-list");if(!t)return;const s=Date.now(),i=[];if(e.forEach(o=>{if(o.lastSeen){const a=o.lastSeen.toMillis?o.lastSeen.toMillis():s;s-a<9e4&&i.push(o)}else i.push(o)}),i.length===0){t.innerHTML='<tr><td colspan="3" style="text-align: center; padding: 1rem;">لا يوجد طلاب متصلين حالياً.</td></tr>';return}const n=document.createDocumentFragment();i.forEach(o=>{const a=document.createElement("tr");a.style.borderBottom="1px solid rgba(255,255,255,0.05)",a.innerHTML=`
                    ...
                    `,n.appendChild(a)}),t.innerHTML="",t.appendChild(n)})}destroy(){this.unsubscribe&&this.unsubscribe()}},P=new T,V=class{init(e){this.controller=e}},O=new V,R=class{constructor(){this.controller=null,this.unsubscribePresence=null,this.onlineCount=0}init(e){this.controller=e,this.startListening()}startListening(){const e=this.controller.engine.courseId;this.unsubscribePresence=k.listenToActiveUsers(e,t=>{const s=Date.now();let i=0;t.forEach(n=>{if(n.lastSeen){const o=n.lastSeen.toMillis?n.lastSeen.toMillis():s;s-o<9e4&&i++}else i++}),this.onlineCount=i,this.updateUI()})}updateUI(){const e=document.getElementById("inst-stat-online");e&&(e.innerText=this.onlineCount)}destroy(){this.unsubscribePresence&&this.unsubscribePresence()}},z=new R,D=class{constructor(){this.engine=null,this.isInitialized=!1,this.activeSessionsUnsubscribe=null}init(e){this.isInitialized||(this.engine=e,this.engine.isInstructor&&(A.init(this),c.init(this),_.init(this),P.init(this),O.init(this),z.init(this),this.isInitialized=!0,this.restoreVideoManagementPanel(),this.listenForHandRaises()))}async updateProfile(e){try{await y.updateProfile(this.engine.currentUser.uid,e),await y.updateCourseProfile(this.engine.courseId,e)}catch(t){throw t}}async promptVideoUpload(){const e=document.createElement("input");e.type="file",e.accept="video/mp4,video/webm,video/ogg",e.onchange=async t=>{const s=t.target.files[0];if(!s)return;const i=document.getElementById("btn-video-upload");i&&(i.disabled=!0,i.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الرفع...');try{const n=await y.uploadMedia(s,`courses/${this.engine.courseId}/videos`);await g.updateCourse(this.engine.courseId,{activeVideoUrl:n}),await c.setMode("video",{isLive:!1,videoUrl:n,status:"playing",timestamp:0}),this._showVideoManagementPanel(n,s.name)}catch(n){alert("فشل رفع الفيديو: "+n.message)}finally{i&&(i.disabled=!1,i.innerHTML='<i class="fas fa-upload"></i> رفع فيديو')}},e.click()}async deleteVideo(){try{const e=(await g.getCourse(this.engine.courseId))?.activeVideoUrl;if(e)try{await S.deleteStorageObjectByUrl(e)}catch{}await g.clearActiveVideo(this.engine.courseId),await c.setMode("video",{isLive:!1,videoUrl:null,status:"paused"}),this._hideVideoManagementPanel()}catch(e){alert("فشل حذف الفيديو: "+e.message)}}async replaceVideo(){try{const e=(await g.getCourse(this.engine.courseId))?.activeVideoUrl;if(e)try{await S.deleteStorageObjectByUrl(e)}catch{}}catch{}this.promptVideoUpload()}_showVideoManagementPanel(e,t){const s=document.getElementById("video-management-panel");if(!s)return;const i=document.getElementById("current-video-name"),n=document.getElementById("current-video-preview");i&&(i.textContent=t||"فيديو محمّل"),n&&(n.src=e),s.style.display="block",s.style.animation="fadeIn 0.3s ease"}_hideVideoManagementPanel(){const e=document.getElementById("video-management-panel");e&&(e.style.display="none");const t=document.getElementById("current-video-preview");t&&(t.src="")}async restoreVideoManagementPanel(){try{const e=(await g.getCourse(this.engine.courseId))?.activeVideoUrl;e&&this._showVideoManagementPanel(e,"فيديو محمّل مسبقاً")}catch{}}async playVideo(){await c.setMode("video",{status:"playing"})}async pauseVideo(){await c.setMode("video",{status:"paused"})}async startAgoraLive(){try{const{MediaEngine:e}=await l(async()=>{const{MediaEngine:t}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));await c.setMode("live",{isLive:!0}),await e.startLiveWebRTC(this.engine.courseId)}catch(e){const{NotificationManager:t}=await l(async()=>{const{NotificationManager:s}=await import("./NotificationManager-yG1gWUIM.js").then(i=>i.n);return{NotificationManager:s}},__vite__mapDeps([7,2]));throw t.show("تعذر بدء البث المباشر: "+e.message,"error"),e}}async stopAgoraLive(){const{MediaEngine:e}=await l(async()=>{const{MediaEngine:t}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));await c.setMode("video",{isLive:!1}),e.stopLiveWebRTC(this.engine.courseId)}async toggleAgoraMic(){const{MediaEngine:e}=await l(async()=>{const{MediaEngine:s}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:s}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15])),t=e.toggleMic();document.getElementById("btn-agora-mic").innerHTML=t?'<i class="fas fa-microphone-slash"></i> تم الكتم':'<i class="fas fa-microphone"></i> كتم المايك'}async switchAgoraCamera(){const{MediaEngine:e}=await l(async()=>{const{MediaEngine:t}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));e.switchCamera()}async setTeachingMode(e,t={}){await c.setMode(e,t),e==="slides"&&this.loadSlidesGallery()}async loadSlidesGallery(){try{const e=await g.getCourse(this.engine.courseId)||{};this.courseSlides=e.slidesGallery||[],this.renderSlidesGallery()}catch{}}renderSlidesGallery(){const e=document.getElementById("inst-slides-gallery");e&&(e.innerHTML="",this.selectedSlides=[],this.courseSlides.forEach((t,s)=>{const i=document.createElement("img");i.src=t,i.style.width="100%",i.style.height="60px",i.style.objectFit="cover",i.style.borderRadius="4px",i.style.cursor="pointer",i.style.border="2px solid transparent",i.onclick=()=>{if(this.selectedSlides.includes(t))this.selectedSlides=this.selectedSlides.filter(n=>n!==t),i.style.borderColor="transparent";else{const n=document.getElementById("inst-slides-layout"),o=n?n.value:"slides-layout-1";let a=1;if(o==="slides-layout-2"?a=2:o==="slides-layout-3"?a=3:o==="slides-layout-4"?a=4:o==="slides-layout-5"&&(a=5),this.selectedSlides.length>=a){const r=this.selectedSlides.shift();e.querySelectorAll("img").forEach(d=>{d.src===r&&(d.style.borderColor="transparent")})}this.selectedSlides.push(t),i.style.borderColor="#34d399"}},e.appendChild(i)}))}async uploadSlides(e){const t=Array.from(e.target.files);if(t.length)try{const s=t.map(n=>y.uploadMedia(n,`courses/${this.engine.courseId}/slides`)),i=await Promise.all(s);await g.addSlidesToGallery(this.engine.courseId,i),await this.loadSlidesGallery(),alert("تم رفع الصور بنجاح.")}catch(s){alert("فشل رفع الصور: "+s.message)}}handleSlideLayoutChange(e){const t=e.target.value;let s=1;if(t==="slides-layout-2"?s=2:t==="slides-layout-3"?s=3:t==="slides-layout-4"?s=4:t==="slides-layout-5"&&(s=5),this.selectedSlides&&this.selectedSlides.length>s){const i=this.selectedSlides.length-s,n=this.selectedSlides.splice(0,i),o=document.getElementById("inst-slides-gallery");o&&o.querySelectorAll("img").forEach(a=>{n.includes(a.src)&&(a.style.borderColor="transparent")})}}async presentSelectedSlides(){if(!this.selectedSlides||this.selectedSlides.length===0){alert("يرجى اختيار صورة واحدة على الأقل للعرض.");return}const e=document.getElementById("inst-slides-layout"),t=e?e.value:"slides-layout-1";await c.setMode("slides",{slides:this.selectedSlides,layout:t,audioStream:this.isSlidesAudioActive||!1})}async startSlidesAudio(){const{MediaEngine:e}=await l(async()=>{const{MediaEngine:t}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isSlidesAudioActive=!0,document.getElementById("btn-slides-mic-start").style.display="none",document.getElementById("btn-slides-mic-stop").style.display="block",await c.setMode("slides",{slides:this.selectedSlides||[],layout:document.getElementById("inst-slides-layout")?.value||"slides-layout-1",audioStream:!0}),e.startAudioOnlyWebRTC(this.engine.courseId)}async stopSlidesAudio(){const{MediaEngine:e}=await l(async()=>{const{MediaEngine:t}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isSlidesAudioActive=!1,document.getElementById("btn-slides-mic-start").style.display="block",document.getElementById("btn-slides-mic-stop").style.display="none",await c.setMode("slides",{slides:this.selectedSlides||[],layout:document.getElementById("inst-slides-layout")?.value||"slides-layout-1",audioStream:!1}),e.stopLiveWebRTC(this.engine.courseId)}async startAudioOnly(){const{MediaEngine:e}=await l(async()=>{const{MediaEngine:t}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isAudioOnlyActive=!0,document.getElementById("btn-audio-start").style.display="none",document.getElementById("btn-audio-stop").style.display="block",await c.setMode("audio",{audioStream:!0}),e.startAudioOnlyWebRTC(this.engine.courseId)}async stopAudioOnly(){const{MediaEngine:e}=await l(async()=>{const{MediaEngine:t}=await import("./MediaEngine-DrsiXtmw.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isAudioOnlyActive=!1,document.getElementById("btn-audio-start").style.display="block",document.getElementById("btn-audio-stop").style.display="none",await c.setMode("audio",{audioStream:!1}),e.stopLiveWebRTC(this.engine.courseId)}async sendChannelMessage(){const e=document.getElementById("inst-channel-text");if(!e||!e.value.trim())return;const t=e.value.trim();e.value="";const s={type:"text",content:t,timestamp:Date.now()};try{const{InstructorService:i}=await l(async()=>{const{InstructorService:n}=await import("./InstructorService-JteGwn_z.js");return{InstructorService:n}},[]);await i.addChannelMessage(this.engine.courseId,s),await c.setMode("channel",{lastMessage:s})}catch{}}async sendChannelImage(e){const t=e.target.files[0];if(t){e.target.value="";try{const{InstructorService:s}=await l(async()=>{const{InstructorService:n}=await import("./InstructorService-JteGwn_z.js");return{InstructorService:n}},[]),i={type:"image",content:await s.uploadMedia(t,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await s.addChannelMessage(this.engine.courseId,i),await c.setMode("channel",{lastMessage:i})}catch(s){alert("فشل رفع الصورة: "+s.message)}}}async sendChannelVideo(e){const t=e.target.files[0];if(t){e.target.value="";try{const{InstructorService:s}=await l(async()=>{const{InstructorService:n}=await import("./InstructorService-JteGwn_z.js");return{InstructorService:n}},[]),i={type:"video",content:await s.uploadMedia(t,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await s.addChannelMessage(this.engine.courseId,i),await c.setMode("channel",{lastMessage:i})}catch(s){alert("فشل رفع الفيديو: "+s.message)}}}async toggleChannelVoice(){const e=document.getElementById("btn-channel-voice");if(this.isRecordingVoice)this.mediaRecorder.stop(),this.isRecordingVoice=!1,e.innerHTML='<i class="fas fa-microphone"></i> تسجيل صوتي',e.classList.replace("btn-danger","btn-dark"),this.audioStream&&(this.audioStream.getTracks().forEach(t=>t.stop()),this.audioStream=null);else try{this.audioStream=await navigator.mediaDevices.getUserMedia({audio:{noiseSuppression:!0,echoCancellation:!0,autoGainControl:!0,channelCount:1,sampleRate:44100}}),this.mediaRecorder=new MediaRecorder(this.audioStream),this.audioChunks=[],this.mediaRecorder.ondataavailable=t=>{t.data.size>0&&this.audioChunks.push(t.data)},this.mediaRecorder.onstop=async()=>{const t=new Blob(this.audioChunks,{type:"audio/webm"}),s=new File([t],`audio_${Date.now()}.webm`,{type:"audio/webm"});try{const{InstructorService:i}=await l(async()=>{const{InstructorService:o}=await import("./InstructorService-JteGwn_z.js");return{InstructorService:o}},[]),n={type:"audio",content:await i.uploadMedia(s,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await i.addChannelMessage(this.engine.courseId,n),await c.setMode("channel",{lastMessage:n})}catch(i){const{NotificationManager:n}=await l(async()=>{const{NotificationManager:o}=await import("./NotificationManager-yG1gWUIM.js").then(a=>a.n);return{NotificationManager:o}},__vite__mapDeps([7,2]));n.show("فشل رفع المقطع الصوتي: "+i.message,"error")}},this.mediaRecorder.start(),this.isRecordingVoice=!0,e.innerHTML='<i class="fas fa-stop-circle"></i> إيقاف التسجيل',e.classList.replace("btn-dark","btn-danger")}catch{const{NotificationManager:s}=await l(async()=>{const{NotificationManager:i}=await import("./NotificationManager-yG1gWUIM.js").then(n=>n.n);return{NotificationManager:i}},__vite__mapDeps([7,2]));s.show("لم نتمكن من الوصول إلى الميكروفون. يرجى التأكد من منح الصلاحيات.","error")}}showHandRaiseNotification(e,t){const s=document.getElementById("hand-raise-toasts");if(!s)return;const i=document.createElement("div");i.className="hand-raise-toast",i.dataset.uid=t,i.innerHTML=`
        ...
        `,i.querySelector(".toast-allow-btn").addEventListener("click",()=>{this.allowStudentMic(t,e),i.remove()}),s.appendChild(i),setTimeout(()=>{i.parentNode&&i.remove()},15e3)}async allowStudentMic(e,t){try{await x.setSessionState(this.engine.courseId,{[`micPermissions.${e}`]:!0});const{NotificationManager:s}=await l(async()=>{const{NotificationManager:i}=await import("./NotificationManager-yG1gWUIM.js").then(n=>n.n);return{NotificationManager:i}},__vite__mapDeps([7,2]));s.show(`تم السماح لـ ${t} بالكلام`,"success")}catch{}}async revokeStudentMic(e){try{await x.revokeMicPermission(this.engine.courseId,e)}catch{}}listenForHandRaises(){this._handRaiseUnsubscribe=x.onHandRaisesSnapshot(this.engine.courseId,e=>{e.forEach(t=>{if(t.type==="added"){const s=t.doc.data();this.showHandRaiseNotification(s.name||"طالب",t.doc.id)}})})}showHandRaiseNotification(e,t){}destroy(){this._handRaiseUnsubscribe&&(this._handRaiseUnsubscribe(),this._handRaiseUnsubscribe=null),this.activeSessionsUnsubscribe&&(this.activeSessionsUnsubscribe(),this.activeSessionsUnsubscribe=null),this.isInitialized=!1,this.engine=null}},q=new D;export{q as InstructorController,M as n,y as t};
