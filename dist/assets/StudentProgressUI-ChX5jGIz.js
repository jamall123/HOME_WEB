import{n,r as s,t as i}from"./courseRoom-9yqrtf6f.js";var d=class{constructor(){this.engine=null}async init(t){this.engine=t,this.injectTab()}injectTab(){const t=document.getElementById("student-tabs");if(!t)return;const e=document.createElement("button");e.className="tab-btn",e.dataset.target="tab-content-progress",e.innerHTML='<i class="fas fa-chart-line"></i> تقدمي',t.appendChild(e);const a=document.createElement("div");a.id="tab-content-progress",a.className="tab-content",document.getElementById("student-dashboard")?.appendChild(a),e.addEventListener("click",()=>{document.querySelectorAll("#student-tabs .tab-btn").forEach(r=>r.classList.remove("active")),document.querySelectorAll(".tab-content").forEach(r=>r.classList.remove("active")),e.classList.add("active"),a.classList.add("active"),this.renderDashboard(a)})}async renderDashboard(t){t.innerHTML='<div style="text-align:center; padding: 2rem;"><i class="fas fa-spinner fa-spin fa-2x"></i> جاري جلب الإحصائيات...</div>';try{const e=await s.fetchStudentDashboardData(this.engine.currentUser.uid);t.innerHTML=`
            ...
            `,document.getElementById("btn-download-progress").addEventListener("click",()=>{i.generateStudentReport([[e.completedLessons.length,e.completionPercentage,e.attendanceMinutes,e.downloadedResources,e.calculatedScore]])}),setTimeout(()=>{n.renderBarChart("student-activity-chart",[10,20,15,30,e.attendanceMinutes%50],["الأحد","الاثنين","الثلاثاء","الأربعاء","الخميس"],"#3498db")},100)}catch(e){t.innerHTML='<div style="color:var(--danger); padding: 1rem;">حدث خطأ أثناء تحميل البيانات</div>',console.error(e)}}},o=new d;export{o as StudentProgressUI};
