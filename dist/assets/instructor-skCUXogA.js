const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/CommandBus-C_R7KGFc.js","assets/UserRepository-Qg-1MUAM.js","assets/rolldown-runtime-BQ-_32WO.js","assets/CourseRepository-BkU7rJA0.js","assets/courseRoom-9XAruR8r.js","assets/firebase-config-DkUYsNQt.js","assets/EventBus-CDVHeIyw.js","assets/NotificationManager-DMg0JkUo.js","assets/preload-helper-BATLnrmA.js","assets/CurriculumRepository-BAvZwOTt.js","assets/CurriculumProgress-BAAnDeGs.js","assets/StudentProgressRepository-kYhNGkTs.js","assets/courseRoom-BrFk4XgN.css","assets/sudanFree-CgE2LGLP.css","assets/MediaEngine-D-Ye7Z7R.js","assets/MediaRepository-CV7UmlOS.js"])))=>i.map(i=>d[i]);
import{n as f,r as w,t as h}from"./CourseRepository-BkU7rJA0.js";import{r as M,t as C}from"./EventBus-CDVHeIyw.js";import{t as d}from"./preload-helper-BATLnrmA.js";import{i as S,t as I}from"./courseRoom-9XAruR8r.js";import{t as k}from"./MediaRepository-CV7UmlOS.js";import"./InstructorAnalyticsUI-Bd4L8cCa.js";var b={get db(){return w.getFirestore()},get storage(){return w.getStorage()},async updateProfile(e,t){if(!e)throw new Error("No UID provided");await this.db.collection(f.COLLECTIONS.USERS).doc(e).set(t,{merge:!0})},async updateCourseProfile(e,t){if(!e)throw new Error("No courseId provided");await this.db.collection(f.COLLECTIONS.COURSES).doc(e).set({instructor:t.name||null,instructorSpecialty:t.specialty||null,instructorBio:t.bio||null,instructorPhoto:t.photo||null},{merge:!0})},uploadMedia(e,t,i=null){return new Promise((s,n)=>{const o=this.storage.ref().child(`${t}/${Date.now()}_${e.name}`).put(e);o.on("state_changed",a=>{i&&i(a.bytesTransferred/a.totalBytes*100)},a=>n(a),async()=>{s(await o.snapshot.ref.getDownloadURL())})})},async updateTeachingMode(e,t){const i={updatedAt:w.getFirestoreFieldValue().serverTimestamp()};for(const[s,n]of Object.entries(t))if(s==="metadata"&&typeof n=="object")for(const[o,a]of Object.entries(n))i[`metadata.${o}`]=a;else i[s]=n;try{await this.db.collection(f.COLLECTIONS.ACTIVE_SESSIONS).doc(e).update(i)}catch{const n={...t,updatedAt:w.getFirestoreFieldValue().serverTimestamp()};await this.db.collection(f.COLLECTIONS.ACTIVE_SESSIONS).doc(e).set(n,{merge:!0})}},async addChannelMessage(e,t){if(!e)throw new Error("No courseId provided");await this.db.collection(f.COLLECTIONS.COURSES).doc(e).collection(f.COLLECTIONS.CHANNEL_MESSAGES).add(t)},async updateClassroomState(e,t){await this.db.collection(f.COLLECTIONS.ACTIVE_SESSIONS).doc(e).set({permissions:t,updatedAt:w.getFirestoreFieldValue().serverTimestamp()},{merge:!0})},async getResources(e){return(await this.db.collection(f.COLLECTIONS.LESSON_RESOURCES).where("courseId","==",e).get()).docs.map(t=>({id:t.id,...t.data()}))},async dispatchCommand(e){const{commandBus:t}=await d(async()=>{const{commandBus:i}=await import("./CommandBus-C_R7KGFc.js");return{commandBus:i}},__vite__mapDeps([0,1,2,3]));return t.dispatch(e)},async postAnnouncement(e,t){await this.db.collection(f.COLLECTIONS.LESSON_ANNOUNCEMENTS).add({courseId:e,...t,timestamp:w.getFirestoreFieldValue().serverTimestamp()})}},B=class{constructor(){}async updateProfile(e,t){await b.updateProfile(e,t)}async updateCourseProfile(e,t){await b.updateCourseProfile(e,t)}uploadMedia(e,t,i=null){return b.uploadMedia(e,t,i)}async updateTeachingMode(e,t){await b.updateTeachingMode(e,t)}async addChannelMessage(e,t,i){t&&(i.lessonId=t),await b.addChannelMessage(e,i)}async updateClassroomState(e,t){await b.updateClassroomState(e,t)}async getResources(e){return await b.getResources(e)}async postAnnouncement(e,t){await b.postAnnouncement(e,t)}},v=new B,g={show({icon:e="📢",title:t="تأكيد",body:i="",okLabel:s="تأكيد",cancelLabel:n="إلغاء",danger:o=!1}={}){return new Promise(a=>{const r=document.getElementById("room-confirm-overlay"),l=document.getElementById("confirm-icon"),p=document.getElementById("confirm-title"),c=document.getElementById("confirm-body"),m=document.getElementById("confirm-ok-btn"),y=document.getElementById("confirm-cancel-btn");if(!r){a(!0);return}l&&(l.textContent=e),p&&(p.textContent=t),c&&(c.textContent=i),m&&(m.textContent=s),y&&(y.textContent=n),m&&(m.className=o?"btn-confirm-ok danger-ok":"btn-confirm-ok");const x=E=>{r.classList.remove("active"),m.onclick=null,y.onclick=null,a(E)};m.onclick=()=>x(!0),y.onclick=()=>x(!1),r.onclick=E=>{E.target===r&&x(!1)},r.classList.add("active")})},alert({icon:e="ℹ️",title:t="تنبيه",body:i="",okLabel:s="حسناً"}={}){return new Promise(n=>{const o=document.getElementById("room-confirm-overlay");if(!o){n();return}document.getElementById("confirm-icon").textContent=e,document.getElementById("confirm-title").textContent=t,document.getElementById("confirm-body").textContent=i,document.getElementById("confirm-ok-btn").textContent=s,document.getElementById("confirm-cancel-btn").style.display="none";const a=document.getElementById("confirm-ok-btn");a.className="btn-confirm-ok";const r=()=>{o.classList.remove("active"),a.onclick=null,document.getElementById("confirm-cancel-btn").style.display="",n()};a.onclick=()=>r(),o.onclick=l=>{l.target===o&&r()},o.classList.add("active")})}},L={show({title:e="بيانات الدرس",body:t="يرجى إدخال عنوان وتفاصيل الدرس الجديد",okLabel:i="حفظ",cancelLabel:s="إلغاء"}={}){return new Promise(n=>{const o=document.getElementById("room-prompt-overlay"),a=document.getElementById("prompt-title"),r=document.getElementById("prompt-body"),l=document.getElementById("prompt-input-title"),p=document.getElementById("prompt-input-desc"),c=document.getElementById("prompt-ok-btn"),m=document.getElementById("prompt-cancel-btn");if(!o){n({title:null,description:null});return}a&&(a.textContent=e),r&&(r.textContent=t),c&&(c.textContent=i),m&&(m.textContent=s),l.value="",p.value="";const y=x=>{o.classList.remove("active"),c.onclick=null,m.onclick=null,n(x?{title:l.value.trim()||null,description:p.value.trim()||""}:{title:null,description:null})};c.onclick=()=>y(!0),m.onclick=()=>y(!1),o.classList.add("active"),l.focus()})}};window.RoomConfirmDialog=g;window.RoomPromptDialog=L;var _=class{init(e){this.controller=e,this.cacheDOM(),this.renderDashboardLayout(),this.attachListeners()}cacheDOM(){this.mountPoint=document.getElementById("instructor-dashboard-mount"),this.tabBtn=document.getElementById("tab-btn-instructor-side")}renderDashboardLayout(){this.mountPoint&&(this.tabBtn&&(this.tabBtn.style.display="flex"),this.mountPoint.innerHTML=`
...
هل أنت جاهز لبدء البث؟`,okLabel:"بدء البث"})&&(this.controller.startAgoraLive().catch(async i=>{await g.alert({icon:"❌",title:"خطأ",body:"تعذر بدء البث: "+i.message})}),document.getElementById("btn-start-agora-live").style.display="none",document.getElementById("btn-stop-agora-live").style.display="block",document.getElementById("live-on-badge").style.display="inline",document.getElementById("live-ws-status").textContent="البث نشط الآن",document.getElementById("float-btn-mic").style.display="inline-flex",document.getElementById("float-btn-cam").style.display="inline-flex",document.getElementById("float-btn-stop").style.display="inline-flex",this._startTimer("live-ws-timer"))},stopAgoraLiveDedicated:async()=>{await g.show({icon:"⏹",title:"إنهاء البث",body:"هل تريد إنهاء البث الحي الآن؟",okLabel:"إنهاء البث",danger:!0})&&(this.controller.stopAgoraLive(),document.getElementById("btn-start-agora-live").style.display="block",document.getElementById("btn-stop-agora-live").style.display="none",document.getElementById("live-on-badge").style.display="none",document.getElementById("live-ws-status").textContent="البث غير نشط حالياً",document.getElementById("float-btn-mic").style.display="none",document.getElementById("float-btn-cam").style.display="none",document.getElementById("float-btn-stop").style.display="none",this._stopTimer("live-ws-timer"))},toggleAgoraMic:async()=>{const{MediaEngine:i}=await d(async()=>{const{MediaEngine:a}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:a}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15])),s=i.toggleMic(),n=["btn-agora-mic","btn-live-mic"],o=document.getElementById("float-btn-mic");n.forEach(a=>{const r=document.getElementById(a);r&&(r.innerHTML=s?'<i class="fas fa-microphone-slash"></i> مكتوم':'<i class="fas fa-microphone"></i> المايك',s?r.classList.add("btn-danger"):r.classList.remove("btn-danger"))}),o&&(o.innerHTML=s?'<i class="fas fa-microphone-slash"></i><span class="fb-label"> مكتوم</span>':'<i class="fas fa-microphone"></i><span class="fb-label"> المايك</span>',s?o.classList.add("active"):o.classList.remove("active"))},switchAgoraCamera:async()=>{const{MediaEngine:i}=await d(async()=>{const{MediaEngine:s}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:s}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));i.switchCamera()},sendChannelMessage:async()=>{const i=document.getElementById("inst-channel-text"),s=i?i.value.trim():"";if(!s){await g.alert({icon:"✏️",title:"الرسالة فارغة",body:"يرجى كتابة رسالة قبل الإرسال."});return}await g.show({icon:"📢",title:"تأكيد إرسال الرسالة",body:s.length>120?s.slice(0,120)+"...":s,okLabel:"إرسال"})&&this.controller.sendChannelMessage()},sendChannelImage:async i=>{const s=i.target.files[0];s&&(await g.show({icon:"🖼️",title:"إرسال صورة",body:`هل تريد إرسال الصورة "${s.name}" للطلاب؟`,okLabel:"إرسال الصورة"})?this.controller.sendChannelImage(i):i.target.value="")},sendChannelVideo:async i=>{const s=i.target.files[0];s&&(await g.show({icon:"🎬",title:"إرسال فيديو",body:`هل تريد إرسال الفيديو "${s.name}" للطلاب؟`,okLabel:"إرسال الفيديو"})?this.controller.sendChannelVideo(i):i.target.value="")},toggleChannelVoice:()=>this.controller.toggleChannelVoice()},this._wireFloatBar(),this._updateFloatBar("video");const e=this.mountPoint.querySelectorAll(".inst-nav");e.forEach(i=>{i.addEventListener("click",s=>{const n=s.currentTarget.getAttribute("data-view");e.forEach(a=>{a.classList.remove("btn-primary"),a.classList.add("btn-dark")}),s.currentTarget.classList.remove("btn-dark"),s.currentTarget.classList.add("btn-primary"),this.mountPoint.querySelectorAll(".inst-view").forEach(a=>a.style.display="none");const o=this.mountPoint.querySelector(`#inst-view-${n}`);o&&(o.style.display="flex"),n==="dashboard"&&o&&(o.style.flexDirection="column")})});const t=this.mountPoint.querySelector("#inst-profile-form");t&&t.addEventListener("submit",async i=>{i.preventDefault();const s=t.querySelector('button[type="submit"]'),n=s.innerHTML;s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...',s.disabled=!0;const o={name:document.getElementById("inst-prof-name").value.trim(),specialty:document.getElementById("inst-prof-spec").value.trim(),bio:document.getElementById("inst-prof-bio").value.trim()},a=document.getElementById("inst-prof-photo").files[0],r=document.getElementById("inst-prof-cv").files[0];try{const{InstructorService:l}=await d(async()=>{const{InstructorService:p}=await import("./InstructorService-Bh9HEvg3.js");return{InstructorService:p}},[]);a&&(s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري رفع الصورة...',o.photo=await l.uploadMedia(a,`profiles/${this.controller.engine.currentUser.uid}`)),r&&(s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري رفع السيرة...',o.cv=await l.uploadMedia(r,`profiles/${this.controller.engine.currentUser.uid}`)),s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الحفظ...',await this.controller.updateProfile(o),s.innerHTML='<i class="fas fa-check"></i> تم الحفظ بنجاح',setTimeout(()=>{s.innerHTML=n,s.disabled=!1},3e3)}catch(l){await g.alert({icon:"❌",title:"خطأ",body:"حدث خطأ: "+(l.message||"")}),s.innerHTML=n,s.disabled=!1}})}_startTimer(e){this._stopTimer(e);const t=document.getElementById(e);if(!t)return;t.style.display="block";let i=0;this._timers=this._timers||{},this._timers[e]=setInterval(()=>{i++;const s=String(Math.floor(i/60)).padStart(2,"0"),n=String(i%60).padStart(2,"0");t.textContent=`${s}:${n}`},1e3)}_stopTimer(e){this._timers&&this._timers[e]&&(clearInterval(this._timers[e]),delete this._timers[e]);const t=document.getElementById(e);t&&(t.style.display="none",t.textContent="00:00")}_updateFloatBar(e){const t=document.getElementById("instructor-float-bar"),i=document.getElementById("float-mode-label"),s=document.getElementById("float-mode-text");if(!t)return;t.classList.add("visible");const n={video:{cls:"mode-video",icon:"fa-video",text:"فيديو"},link:{cls:"mode-video",icon:"fa-link",text:"رابط"},live:{cls:"mode-live",icon:"fa-satellite-dish",text:"بث حي"},slides:{cls:"mode-slides",icon:"fa-images",text:"شرائح"},audio:{cls:"mode-audio",icon:"fa-podcast",text:"صوت فقط"},channel:{cls:"mode-channel",icon:"fa-bullhorn",text:"قناة"}},o=n[e]||n.video;i&&(i.className=`float-bar-mode-label ${o.cls}`,i.innerHTML=`<i class="fas ${o.icon}"></i>`),s&&(s.textContent=o.text);const a=document.getElementById("float-btn-mic"),r=document.getElementById("float-btn-cam"),l=document.getElementById("float-btn-stop");a&&(a.style.display="none"),r&&(r.style.display="none"),l&&(l.style.display="none"),e==="live"?(a&&(a.style.display="inline-flex"),r&&(r.style.display="inline-flex"),l&&(l.style.display="inline-flex")):e==="audio"&&(a&&(a.style.display="inline-flex"),l&&(l.style.display="inline-flex"))}_wireFloatBar(){const e=document.getElementById("float-btn-mic"),t=document.getElementById("float-btn-cam"),i=document.getElementById("float-btn-stop");e&&e.addEventListener("click",()=>window.InstructorAPI.toggleAgoraMic()),t&&t.addEventListener("click",()=>window.InstructorAPI.switchAgoraCamera()),i&&i.addEventListener("click",async()=>{const s=document.getElementById("float-mode-text")?.textContent;s==="بث حي"?window.InstructorAPI.stopAgoraLiveDedicated():s==="صوت فقط"?window.InstructorAPI.stopAudioOnly():s==="شرائح"&&window.InstructorAPI.stopSlidesAudio()})}},A=new _,T=class{init(e){this.controller=e}async setMode(e,t={}){const i={mode:e,metadata:t};await v.updateTeachingMode(this.controller.engine.courseId,i)}},u=new T,P=class{constructor(){this.controller=null}init(e){this.controller=e,this.attachListeners()}attachListeners(){const e=document.getElementById("inst-toggle-chat"),t=document.getElementById("inst-toggle-resources");e&&e.addEventListener("change",async i=>{const s=i.target.checked;await v.updateClassroomState(this.controller.engine.courseId,{chatLocked:s})}),t&&t.addEventListener("change",async i=>{const s=i.target.checked;await v.updateClassroomState(this.controller.engine.courseId,{resourcesLocked:s})})}},R=new P,V=class{constructor(){this.controller=null,this.unsubscribe=null}init(e){this.controller=e,this.startListening()}startListening(){this.activeStudentsMap=new Map,this.unsubscribe=S.listenToActiveUsers(this.controller.engine.courseId,e=>{const t=document.getElementById("instructor-student-list");if(!t)return;const i=Date.now(),s=[];if(this.activeStudentsMap.clear(),e.forEach(o=>{if(o.lastSeen){const a=o.lastSeen.toMillis?o.lastSeen.toMillis():i;i-a<9e4&&(s.push(o),o.userId&&this.activeStudentsMap.set(o.userId,o))}else s.push(o),o.userId&&this.activeStudentsMap.set(o.userId,o)}),s.length===0){t.innerHTML='<div style="text-align: center; padding: 2rem; color: var(--text-secondary); background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.06); border-radius: 12px;">لا يوجد طلاب متصلين حالياً.</div>';return}const n=document.createDocumentFragment();s.forEach(o=>{const a=document.createElement("div");a.style.cssText="display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; gap: 1rem; padding: 1rem; background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); border-radius: 10px;",a.innerHTML=`
                ...
                `,n.appendChild(a)}),t.innerHTML="",t.appendChild(n),this.delegationAdded||(t.addEventListener("click",o=>{const a=o.target.closest(".btn-student-details");if(a){const c=a.getAttribute("data-uid"),m=this.activeStudentsMap.get(c);m&&this.showDetailsModal(m);return}const r=o.target.closest(".btn-student-unmute");if(r){const c=r.getAttribute("data-uid"),m=this.activeStudentsMap.get(c);confirm("هل تريد السماح لهذا الطالب بالتحدث وإعطائه المايك؟")&&this.controller.allowStudentMic(c,m?m.name:"الطالب");return}const l=o.target.closest(".btn-student-mute");if(l){const c=l.getAttribute("data-uid");confirm("هل أنت متأكد من سحب صلاحية الميكروفون من هذا الطالب؟")&&this.controller.revokeStudentMic(c);return}const p=o.target.closest(".btn-student-kick");if(p){const c=p.getAttribute("data-uid");confirm("هل أنت متأكد من طرد هذا الطالب من الغرفة؟")&&this.controller.kickStudent(c);return}}),this.delegationAdded=!0)})}showDetailsModal(e){let t=document.getElementById("inst-student-details-modal");t||(t=document.createElement("div"),t.id="inst-student-details-modal",t.style.cssText="position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.8); z-index:99999; display:flex; align-items:center; justify-content:center;",t.innerHTML=`
        ...
        `,t.style.display="flex"}destroy(){this.unsubscribe&&this.unsubscribe();const e=document.getElementById("inst-student-details-modal");e&&e.remove()}},O=new V,z=class{init(e){this.controller=e}},D=new z,N=class{constructor(){this.controller=null,this.unsubscribePresence=null,this.onlineCount=0}init(e){this.controller=e,this.startListening()}startListening(){const e=this.controller.engine.courseId;this.unsubscribePresence=S.listenToActiveUsers(e,t=>{const i=Date.now();let s=0;t.forEach(n=>{if(n.lastSeen){const o=n.lastSeen.toMillis?n.lastSeen.toMillis():i;i-o<9e4&&s++}else s++}),this.onlineCount=s,this.updateUI()})}updateUI(){const e=document.getElementById("inst-stat-online");e&&(e.innerText=this.onlineCount)}destroy(){this.unsubscribePresence&&this.unsubscribePresence()}},H=new N,U=class{constructor(){this.engine=null,this.isInitialized=!1,this.activeSessionsUnsubscribe=null,this.activeLessonId=null}init(e){if(!this.isInitialized){if(this.engine=e,!this.engine.isInstructor){console.error("SECURITY VIOLATION: Non-instructor attempting to initialize InstructorController.");return}C.subscribe(M.PLAY_LECTURE,t=>{t&&t.id&&(this.activeLessonId=t.id)}),A.init(this),u.init(this),R.init(this),O.init(this),D.init(this),H.init(this),this.isInitialized=!0,this.restoreVideoManagementPanel(),this.listenForHandRaises()}}async updateProfile(e){try{await v.updateProfile(this.engine.currentUser.uid,e),await v.updateCourseProfile(this.engine.courseId,e)}catch(t){throw console.error("Profile update failed",t),t}}async promptVideoUpload(){const e=document.createElement("input");e.type="file",e.accept="video/mp4,video/webm,video/ogg",e.onchange=async t=>{const i=t.target.files[0];if(!i)return;const s=document.getElementById("btn-video-upload");s&&(s.disabled=!0,s.innerHTML='<i class="fas fa-spinner fa-spin"></i> جاري الرفع...');try{const n=await v.uploadMedia(i,`courses/${this.engine.courseId}/videos`);await h.updateCourse(this.engine.courseId,{activeVideoUrl:n}),await u.setMode("video",{isLive:!1,videoUrl:n,status:"playing",timestamp:0}),this._showVideoManagementPanel(n,i.name)}catch(n){alert("فشل رفع الفيديو: "+n.message)}finally{s&&(s.disabled=!1,s.innerHTML='<i class="fas fa-upload"></i> رفع فيديو')}},e.click()}async deleteVideo(){try{const e=(await h.getCourse(this.engine.courseId))?.activeVideoUrl;if(e)try{await k.deleteStorageObjectByUrl(e),console.log("[InstructorController] Deleted temporary active video file")}catch(t){console.warn("[InstructorController] Storage delete failed (may have already been removed):",t.message)}await h.clearActiveVideo(this.engine.courseId),await u.setMode("video",{isLive:!1,videoUrl:null,status:"paused"}),this._hideVideoManagementPanel()}catch(e){alert("فشل حذف الفيديو: "+e.message)}}async replaceVideo(){try{const e=(await h.getCourse(this.engine.courseId))?.activeVideoUrl;if(e)try{await k.deleteStorageObjectByUrl(e),console.log("[InstructorController] Deleted temporary active video file")}catch(t){console.warn("[InstructorController] Could not delete video file from storage",t)}}catch{}this.promptVideoUpload()}_showVideoManagementPanel(e,t){const i=document.getElementById("video-management-panel");if(!i)return;const s=document.getElementById("current-video-name"),n=document.getElementById("current-video-preview");s&&(s.textContent=t||"فيديو محمّل"),n&&(n.src=e,this._attachVideoSyncListeners(n)),i.style.display="block",i.style.animation="fadeIn 0.3s ease"}_attachVideoSyncListeners(e){this._removeVideoSyncListeners(),this._videoTarget=e,this._videoHandlers={play:()=>u.setMode("video",{status:"playing",timestamp:e.currentTime}),pause:()=>u.setMode("video",{status:"paused",timestamp:e.currentTime}),seeked:()=>u.setMode("video",{timestamp:e.currentTime}),timeupdate:(()=>{let t=0;return()=>{const i=Date.now();i-t>2e3&&!e.paused&&(u.setMode("video",{status:"playing",timestamp:e.currentTime}),t=i)}})()},this._videoTarget&&(this._videoTarget.addEventListener("play",this._videoHandlers.play),this._videoTarget.addEventListener("pause",this._videoHandlers.pause),this._videoTarget.addEventListener("seeked",this._videoHandlers.seeked),this._videoTarget.addEventListener("timeupdate",this._videoHandlers.timeupdate))}_removeVideoSyncListeners(){this._videoTarget&&this._videoHandlers&&(this._videoTarget.removeEventListener("play",this._videoHandlers.play),this._videoTarget.removeEventListener("pause",this._videoHandlers.pause),this._videoTarget.removeEventListener("seeked",this._videoHandlers.seeked),this._videoTarget.removeEventListener("timeupdate",this._videoHandlers.timeupdate)),this._videoHandlers=null,this._videoTarget=null}_hideVideoManagementPanel(){const e=document.getElementById("video-management-panel");e&&(e.style.display="none"),this._removeVideoSyncListeners()}async restoreVideoManagementPanel(){try{const e=(await h.getCourse(this.engine.courseId))?.activeVideoUrl;e&&this._showVideoManagementPanel(e,"فيديو محمّل مسبقاً")}catch{}}async playVideo(){const e=document.getElementById("current-video-preview");e&&e.play().catch(t=>console.warn("Play prevented",t))}async pauseVideo(){const e=document.getElementById("current-video-preview");e&&e.pause()}async startAgoraLive(){try{const{MediaEngine:e}=await d(async()=>{const{MediaEngine:t}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));await e.startLiveWebRTC(this.engine.courseId),await u.setMode("live",{isLive:!0})}catch(e){console.error("[InstructorController] Failed to start live stream:",e);const{NotificationManager:t}=await d(async()=>{const{NotificationManager:i}=await import("./NotificationManager-DMg0JkUo.js").then(s=>s.n);return{NotificationManager:i}},__vite__mapDeps([7,2]));throw t.show("تعذر بدء البث المباشر: "+e.message,"error"),e}}async stopAgoraLive(){const{MediaEngine:e}=await d(async()=>{const{MediaEngine:t}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));await u.setMode("video",{isLive:!1}),e.stopLiveWebRTC(this.engine.courseId)}async toggleAgoraMic(){const{MediaEngine:e}=await d(async()=>{const{MediaEngine:i}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:i}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15])),t=e.toggleMic();document.getElementById("btn-agora-mic").innerHTML=t?'<i class="fas fa-microphone-slash"></i> تم الكتم':'<i class="fas fa-microphone"></i> كتم المايك'}async switchAgoraCamera(){const{MediaEngine:e}=await d(async()=>{const{MediaEngine:t}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));e.switchCamera()}async setTeachingMode(e,t={}){const{MediaEngine:i}=await d(async()=>{const{MediaEngine:r}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:r}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isSlidesAudioActive=!1;const s=document.getElementById("btn-slides-mic-start"),n=document.getElementById("btn-slides-mic-stop");s&&(s.style.display="inline-block"),n&&(n.style.display="none"),this.isAudioOnlyActive=!1;const o=document.getElementById("btn-audio-start"),a=document.getElementById("btn-audio-stop");if(o&&(o.style.display="inline-block"),a&&(a.style.display="none"),i.agoraClient||i._isPublishing)try{await i.stopLiveWebRTC(this.engine.courseId)}catch{}await u.setMode(e,t),e==="slides"&&this.loadSlidesGallery()}async loadSlidesGallery(){try{const e=await h.getCourse(this.engine.courseId)||{};this.courseSlides=e.slidesGallery||[],this.renderSlidesGallery()}catch(e){console.error("Failed to load slides gallery",e)}}renderSlidesGallery(){const e=document.getElementById("inst-slides-gallery");e&&(e.innerHTML="",this.selectedSlides=[],this.courseSlides.forEach((t,i)=>{const s=document.createElement("img");s.src=t,s.style.width="100%",s.style.height="60px",s.style.objectFit="cover",s.style.borderRadius="4px",s.style.cursor="pointer",s.style.border="2px solid transparent",s.onclick=()=>{if(this.selectedSlides.includes(t))this.selectedSlides=this.selectedSlides.filter(n=>n!==t),s.style.borderColor="transparent";else{const n=document.getElementById("inst-slides-layout"),o=n?n.value:"slides-layout-1";let a=1;if(o==="slides-layout-2"?a=2:o==="slides-layout-3"?a=3:o==="slides-layout-4"?a=4:o==="slides-layout-5"&&(a=5),this.selectedSlides.length>=a){const r=this.selectedSlides.shift();e.querySelectorAll("img").forEach(l=>{l.src===r&&(l.style.borderColor="transparent")})}this.selectedSlides.push(t),s.style.borderColor="#34d399"}},e.appendChild(s)}))}async uploadSlides(e){const t=Array.from(e.target.files);if(t.length)try{const i=t.map(n=>v.uploadMedia(n,`courses/${this.engine.courseId}/slides`)),s=await Promise.all(i);await h.addSlidesToGallery(this.engine.courseId,s),await this.loadSlidesGallery(),alert("تم رفع الصور بنجاح.")}catch(i){console.error("Failed to upload slides:",i),alert("فشل رفع الصور: "+i.message)}}handleSlideLayoutChange(e){const t=e.target.value;let i=1;if(t==="slides-layout-2"?i=2:t==="slides-layout-3"?i=3:t==="slides-layout-4"?i=4:t==="slides-layout-5"&&(i=5),this.selectedSlides&&this.selectedSlides.length>i){const s=this.selectedSlides.length-i,n=this.selectedSlides.splice(0,s),o=document.getElementById("inst-slides-gallery");o&&o.querySelectorAll("img").forEach(a=>{n.includes(a.src)&&(a.style.borderColor="transparent")})}}async presentSelectedSlides(){if(!this.selectedSlides||this.selectedSlides.length===0){alert("يرجى اختيار صورة واحدة على الأقل للعرض.");return}const e=document.getElementById("inst-slides-layout"),t=e?e.value:"slides-layout-1";await u.setMode("slides",{slides:this.selectedSlides,layout:t,audioStream:this.isSlidesAudioActive||!1})}async startSlidesAudio(){const{MediaEngine:e}=await d(async()=>{const{MediaEngine:t}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isSlidesAudioActive=!0,document.getElementById("btn-slides-mic-start").style.display="none",document.getElementById("btn-slides-mic-stop").style.display="block",await u.setMode("slides",{slides:this.selectedSlides||[],layout:document.getElementById("inst-slides-layout")?.value||"slides-layout-1",audioStream:!0}),e.startAudioOnlyWebRTC(this.engine.courseId)}async stopSlidesAudio(){const{MediaEngine:e}=await d(async()=>{const{MediaEngine:t}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isSlidesAudioActive=!1,document.getElementById("btn-slides-mic-start").style.display="block",document.getElementById("btn-slides-mic-stop").style.display="none",await u.setMode("slides",{slides:this.selectedSlides||[],layout:document.getElementById("inst-slides-layout")?.value||"slides-layout-1",audioStream:!1}),e.stopLiveWebRTC(this.engine.courseId)}async startAudioOnly(){const{MediaEngine:e}=await d(async()=>{const{MediaEngine:t}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isAudioOnlyActive=!0,document.getElementById("btn-audio-start").style.display="none",document.getElementById("btn-audio-stop").style.display="block",await u.setMode("audio",{audioStream:!0}),e.startAudioOnlyWebRTC(this.engine.courseId)}async stopAudioOnly(){const{MediaEngine:e}=await d(async()=>{const{MediaEngine:t}=await import("./MediaEngine-D-Ye7Z7R.js");return{MediaEngine:t}},__vite__mapDeps([14,6,2,8,4,3,5,1,7,9,10,11,12,13,15]));this.isAudioOnlyActive=!1,document.getElementById("btn-audio-start").style.display="block",document.getElementById("btn-audio-stop").style.display="none",await u.setMode("audio",{audioStream:!1}),e.stopLiveWebRTC(this.engine.courseId)}async sendChannelMessage(){const e=document.getElementById("inst-channel-text");if(!e||!e.value.trim())return;const t=e.value.trim();e.value="";const i={type:"text",content:t,timestamp:Date.now()};try{const{InstructorService:s}=await d(async()=>{const{InstructorService:n}=await import("./InstructorService-Bh9HEvg3.js");return{InstructorService:n}},[]);await s.addChannelMessage(this.engine.courseId,this.activeLessonId,i),await u.setMode("channel",{lastMessage:i})}catch(s){console.error("Failed to send channel text:",s)}}async sendChannelImage(e){const t=e.target.files[0];if(t){e.target.value="";try{const{InstructorService:i}=await d(async()=>{const{InstructorService:n}=await import("./InstructorService-Bh9HEvg3.js");return{InstructorService:n}},[]),s={type:"image",content:await i.uploadMedia(t,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await i.addChannelMessage(this.engine.courseId,this.activeLessonId,s),await u.setMode("channel",{lastMessage:s})}catch(i){console.error("Failed to upload channel image:",i),alert("فشل رفع الصورة: "+i.message)}}}async sendChannelVideo(e){const t=e.target.files[0];if(t){e.target.value="";try{const{InstructorService:i}=await d(async()=>{const{InstructorService:n}=await import("./InstructorService-Bh9HEvg3.js");return{InstructorService:n}},[]),s={type:"video",content:await i.uploadMedia(t,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await i.addChannelMessage(this.engine.courseId,this.activeLessonId,s),await u.setMode("channel",{lastMessage:s})}catch(i){console.error("Failed to upload channel video:",i),alert("فشل رفع الفيديو: "+i.message)}}}async toggleChannelVoice(){const e=document.getElementById("btn-channel-voice");if(this.isRecordingVoice)this.mediaRecorder.stop(),this.audioStream.getTracks().forEach(t=>t.stop()),this.audioCtx&&(this.audioCtx.close().catch(t=>console.warn(t)),this.audioCtx=null),this.isRecordingVoice=!1,e.innerHTML='<i class="fas fa-microphone"></i> تسجيل صوتي',e.classList.replace("btn-danger","btn-dark"),this.audioStream&&(this.audioStream.getTracks().forEach(t=>t.stop()),this.audioStream=null);else try{this.audioStream=await navigator.mediaDevices.getUserMedia({audio:{noiseSuppression:!0,echoCancellation:!0,autoGainControl:!0,channelCount:1,sampleRate:44100}});const t=window.AudioContext||window.webkitAudioContext;this.audioCtx=new t;const i=this.audioCtx.createMediaStreamSource(this.audioStream),s=this.audioCtx.createBiquadFilter();s.type="highpass",s.frequency.value=85;const n=this.audioCtx.createBiquadFilter();n.type="lowpass",n.frequency.value=9e3;const o=this.audioCtx.createDynamicsCompressor();o.threshold.value=-40,o.knee.value=30,o.ratio.value=10,o.attack.value=.005,o.release.value=.1,i.connect(s),s.connect(n),n.connect(o);const a=this.audioCtx.createMediaStreamDestination();o.connect(a),this.mediaRecorder=new MediaRecorder(a.stream),this.audioChunks=[],this.mediaRecorder.ondataavailable=r=>{r.data.size>0&&this.audioChunks.push(r.data)},this.mediaRecorder.onstop=async()=>{const r=new Blob(this.audioChunks,{type:"audio/webm"}),l=new File([r],`audio_${Date.now()}.webm`,{type:"audio/webm"});try{const{InstructorService:p}=await d(async()=>{const{InstructorService:m}=await import("./InstructorService-Bh9HEvg3.js");return{InstructorService:m}},[]),c={type:"audio",content:await p.uploadMedia(l,`courses/${this.engine.courseId}/channel`),timestamp:Date.now()};await p.addChannelMessage(this.engine.courseId,this.activeLessonId,c),await u.setMode("channel",{lastMessage:c})}catch(p){console.error("Failed to upload audio:",p);const{NotificationManager:c}=await d(async()=>{const{NotificationManager:m}=await import("./NotificationManager-DMg0JkUo.js").then(y=>y.n);return{NotificationManager:m}},__vite__mapDeps([7,2]));c.show("فشل رفع المقطع الصوتي: "+p.message,"error")}},this.mediaRecorder.start(),this.isRecordingVoice=!0,e.innerHTML='<i class="fas fa-stop-circle"></i> إيقاف التسجيل',e.classList.replace("btn-dark","btn-danger")}catch(t){console.error("Error accessing microphone:",t);const{NotificationManager:i}=await d(async()=>{const{NotificationManager:s}=await import("./NotificationManager-DMg0JkUo.js").then(n=>n.n);return{NotificationManager:s}},__vite__mapDeps([7,2]));i.show("لم نتمكن من الوصول إلى الميكروفون. يرجى التأكد من منح الصلاحيات.","error")}}showHandRaiseNotification(e,t){const i=document.getElementById("hand-raise-toasts");if(!i)return;const s=document.createElement("div");s.className="hand-raise-toast",s.dataset.uid=t,s.innerHTML=`
        ...
        `,s.querySelector(".toast-allow-btn").addEventListener("click",()=>{this.allowStudentMic(t,e),s.remove()}),i.appendChild(s),setTimeout(()=>{s.parentNode&&s.remove()},15e3)}async allowStudentMic(e,t){try{await I.setSessionState(this.engine.courseId,{[`micPermissions.${e}`]:!0});const{NotificationManager:i}=await d(async()=>{const{NotificationManager:s}=await import("./NotificationManager-DMg0JkUo.js").then(n=>n.n);return{NotificationManager:s}},__vite__mapDeps([7,2]));i.show(`تم السماح لـ ${t} بالكلام`,"success")}catch(i){console.error("[InstructorController] allowStudentMic failed:",i)}}async revokeStudentMic(e){try{await I.revokeMicPermission(this.engine.courseId,e),NotificationManager.show("تم سحب صلاحية الميكروفون بنجاح","success")}catch(t){console.error("[InstructorController] revoke mic error",t),NotificationManager.show("حدث خطأ أثناء سحب الصلاحية","error")}}async kickStudent(e){try{await I.kickStudent(this.engine.courseId,e),NotificationManager.show("تم طرد الطالب من الغرفة بنجاح","success")}catch(t){console.error("[InstructorController] kick student error",t),NotificationManager.show("حدث خطأ أثناء محاولة طرد الطالب","error")}}listenForHandRaises(){this._handRaiseUnsubscribe=I.onHandRaisesSnapshot(this.engine.courseId,e=>{e.forEach(t=>{if(t.type==="added"){const i=t.doc.data();this.showHandRaiseNotification(i.name||"طالب",t.doc.id)}})})}showHandRaiseNotification(e,t){const i=document.getElementById("hand-raise-toasts");if(!i)return;const s=document.createElement("div");s.className="hand-raise-toast",s.style.cssText="background:rgba(0,0,0,0.8); border:1px solid var(--primary-color); border-radius:10px; padding:1rem; display:flex; flex-direction:column; gap:0.5rem; animation: slideInRight 0.3s ease;",s.innerHTML=`
        ...
        `,i.appendChild(s),setTimeout(()=>{s.parentElement&&(s.style.animation="slideOutRight 0.3s ease forwards",setTimeout(()=>s.remove(),300),I.cancelMicRequest(this.engine.courseId,t).catch(()=>{}))},2e4)}async handleHandRaise(e,t,i,s){s&&(s.style.animation="slideOutRight 0.3s ease forwards",setTimeout(()=>s.remove(),300));try{await I.cancelMicRequest(this.engine.courseId,e),i&&await this.allowStudentMic(e,t)}catch(n){console.error("[InstructorController] handleHandRaise error:",n)}}destroy(){this._handRaiseUnsubscribe&&(this._handRaiseUnsubscribe(),this._handRaiseUnsubscribe=null),this.activeSessionsUnsubscribe&&(this.activeSessionsUnsubscribe(),this.activeSessionsUnsubscribe=null),this._removeVideoSyncListeners(),this.isInitialized=!1,this.engine=null}},Y=new U;export{Y as InstructorController,B as n,v as t};
